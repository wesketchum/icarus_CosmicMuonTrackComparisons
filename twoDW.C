...
void twoDW(bool verbose=false) {
  ...
  */
  ...
  TH2F *h_pi02D_mc   = new TH2F("h_pi02D_mc","Pitch vs  Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  TH2F *h_pi02D_data = new TH2F("h_pi02D_data","Pitch vs Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  h_pi02D_mc->GetYaxis()->SetTitle("Charge Integral in ADC ");
  ...
  TH2F *h_pi12D_mc   = new TH2F("h_pi12D_mc","Pitch vs  Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  TH2F *h_pi12D_data = new TH2F("h_pi12D_data","Pitch vs Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  h_pi12D_mc->GetYaxis()->SetTitle("Charge Integral in ADC ");
  ...
  TH2F *h_pi22D_mc   = new TH2F("h_pi22D_mc","Pitch vs  Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  TH2F *h_pi22D_data = new TH2F("h_pi22D_data","Pitch vs Charge Integral in ADC: East Cryostat", 50., 0., 25., 50., 0., 2000.);
  h_pi22D_mc->GetYaxis()->SetTitle("Charge Integral in ADC ");
...
//pnfs/icarus/persistent/calibration/calib_ntuples/data/hist_data_dl4_fstrmNUMI*.root"); 
  ...
  TTreeReaderArray<float> pitch2_i1(myReader2, "trk.hits0.pitch");
   ...
   while (myReader.Next()) {
     ...
     if(*selected != 1) continue; //if not stopping, move one.
     //if(*tpc2 != 0) continue;
   ...
   while (myReader2.Next()) {
     if(*selected2 != 1) continue; //if not stopping, move one.
   ...
   cout<<"HERE_C"<<endl;
   cnvs_az2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_AzimuthalAngle_colTEST.pdf");

   //   TFile* my_new_file1 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_AzimuthalAngle_col.root","RECREATE");
   // cnvs_az2->Write();
   ...
   cnvs_az1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_AzimuthalAngle_in1TEST.pdf");
   //cnvs_az1->Write();
   ...
   cnvs_az0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_AzimuthalAngle_in2TEST.pdf");//,"RECREATE");
   //  cnvs_az0->Write();
 cout<<"az0"<<endl;
   Double_t res_az0[20];
   ...
   //      cnvs_az0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_AzimuthalAngle_in2.root","RECREATE");
      //cnvs_az0->Write();
  ...
  cnvs_zz2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_colTEST.pdf");//,"RECREATE");
   //   cnvs_zz2->Write();
   ...
   //   TFile* my_new_file4 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_col.root","RECREATE");
   //cnvs_zz2->Write();
   ...
   cnvs_zz1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_in1TEST.pdf");//,"RECREATE");
   //   cnvs_zz1->Write();
   cout<<"zz1"<<endl;
   Double_t res_zz1[20];
   ...
   //   TFile* my_new_file5 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_in1.root","RECREATE");
   // cnvs_zz1->Write();
   ...
   legende->Draw();
   cnvs_zz0->Update();
   cnvs_zz0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_in2TEST.pdf");//,"RECREATE");
   //   cnvs_zz0->Write();
   cout<<"zz0"<<endl;
   Double_t res_zz0[20];
   ...
   //   TFile* my_new_file6 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_ZenithAngle_in2.root","RECREATE");
   // cnvs_zz0->Write();
   ...
   cnvs_q2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_colTEST.pdf");//,"RECREATE");
   //   cnvs_q2->Write();
   ...
   //   TFile* my_new_file7 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_col.root","RECREATE");
   //cnvs_q2->Write();
   ...
   cnvs_q1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_in1TEST.pdf");//,"RECREATE");
   //   cnvs_q1->Write();
   ...
   //   TFile* my_new_file8 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_in1.root","RECREATE");
   //cnvs_q1->Write();
   ...
   cnvs_q0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_in2TEST.pdf");//,"RECREATE");
   //   cnvs_q0->Write();
   cout<<"q0"<<endl;
   Double_t res_q0[20];
   ...
   //   TFile* my_new_file9 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_filedQdx_in2.root","RECREATE");
   // cnvs_q0->Write();
   ...
   cnvs_r2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_colTEST.pdf");//,"RECREATE");
   //   cnvs_r2->Write();
   cout<<"r2"<<endl;
   Double_t res_r2[20];
   ...
   //   TFile* my_new_file10 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_col.root","RECREATE");
   //  cnvs_r2->Write();
   ...
   cnvs_r1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_in1TEST.pdf");//,"RECREATE");
   //cnvs_r1->Write();
   ...
   //   TFile* my_new_file11 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_in1.root","RECREATE");
   //cnvs_r1->Write();
   ...
   cnvs_r0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_in2TEST.pdf");//,"RECREATE");
   //   cnvs_r0->Write();
   ...
   //   TFile* my_new_file12 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileRR_in2.root","RECREATE");
   //cnvs_r0->Write();
   ...
   cnvs_l->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileLengthTEST.pdf");//,"RECREATE");
   //   cnvs_l->Write();
   ...
   TFile output_file1("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_col.root","RECREATE");
   h1l2Dc_prof->Write();
   h2l2Dc_prof->Write();
   cnvs_l2Dc->Write();

   cnvs_l2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_col.pdf");
   ...
   TFile output_file1z("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Z_col.root","RECREATE");
   hz1l2Dc_prof->Write();
   hz2l2Dc_prof->Write();
   cnvs_zl2Dc->Write();

   cnvs_zl2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Z_col.pdf");
   ...
   */
   ...
   TFile output_file2("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_in1.root","RECREATE");
   h1l2D1_prof->Write();
   h2l2D1_prof->Write();
   cnvs_l2D1->Write();

   cnvs_l2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_in1.pdf");
   ...
   */
   ...
   //   cnvs_l2D1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_in1.pdf");
   ...
   TFile output_file3("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_in2.root","RECREATE");
   h1l2D2_prof->Write();
   h2l2D2_prof->Write();
   cnvs_l2D2->Write();
   /*
   ...
   cnvs_l2D2->Update();
   */
   cnvs_l2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileLength_Az_in2.pdf");
   ...
   //   TFile* my_new_file13 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileLength.root","RECREATE");
   //cnvs_l->Write();
   ...
   cnvs_t0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileT0TEST.pdf");//,"RECREATE");
   //   cnvs_t0->Write();
   ...
   //   TFile* my_new_file14 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileT0.root","RECREATE");
   //cnvs_t0->Write();
   ...
   cnvs_sx->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_colTEST.pdf");//,"RECREATE");
   //   cnvs_sx->Write();
   ...
   TFile output_file4("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_col.root","RECREATE");
   h1n2Dc_prof->Write();
   h2n2Dc_prof->Write();
   cnvs_sx2Dc->Write();


   cnvs_sx2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_col.pdf");
   ...
   TFile output_file5("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_in1.root","RECREATE");
   h1n2D1_prof->Write();
   h2n2D1_prof->Write();
   cnvs_sx2D1->Write();

   cnvs_sx2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_in1.pdf");
   ...
   TFile output_file6("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_in2.root","RECREATE");
   h1n2D2_prof->Write();
   h2n2D2_prof->Write();
   cnvs_sx2D2->Write();
   ...
   cnvs_sx2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_Az_in2.pdf");
   ...
   //   TFile* my_new_file15 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartX_col.root","RECREATE");
   // cnvs_sx->Write();
   ...
   cnvs_sy->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_in1TEST.pdf");//,"RECREATE");
   //  cnvs_sy->Write();
   ...
   TFile output_file7("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_col.root","RECREATE");
   h1o2Dc_prof->Write();
   h2o2Dc_prof->Write();
   cnvs_sy2Dc->Write();

   cnvs_sy2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_col.pdf");
   ...
   TFile output_file8("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_in1.root","RECREATE");
   h1o2D1_prof->Write();
   h2o2D1_prof->Write();
   cnvs_sy2D1->Write();


   cnvs_sy2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_in1.pdf");
   ...
   TFile output_file9("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_in2.root","RECREATE");
   h1o2D2_prof->Write();
   h2o2D2_prof->Write();
   cnvs_sy2D2->Write();


   cnvs_sy2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_Az_in2.pdf");
   ...
   //   TFile* my_new_file16 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartY_in1.root","RECREATE");
   //cnvs_sy->Write();
   ...
   cnvs_sz->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_in2TEST.pdf");//,"RECREATE");
   //   cnvs_sz->Write();
   ...
   TFile output_file10("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_col.root","RECREATE");
   h1p2Dc_prof->Write();
   h2p2Dc_prof->Write();
   cnvs_sz2Dc->Write();

   cnvs_sz2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_col.pdf");
   ...
   TFile output_file11("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_in1.root","RECREATE");
   h1p2D1_prof->Write();
   h2p2D1_prof->Write();
   cnvs_sz2D1->Write();

   cnvs_sz2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_in1.pdf");
   ...
   TFile output_file12("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_in2.root","RECREATE");
   h1p2D2_prof->Write();
   h2p2D2_prof->Write();
   cnvs_sz2D2->Write();


   cnvs_sz2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_Az_in2.pdf");
   ...
   //   TFile* my_new_file17 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileStartZ_in2.root","RECREATE");
   //cnvs_sz->Write();
   ...
   cnvs_ex->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_colTEST.pdf");//,"RECREATE");
   //  cnvs_ex->Write();
   ...
   TFile output_file13("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_col.root","RECREATE");
   h1q2Dc_prof->Write();
   h2q2Dc_prof->Write();
   cnvs_ex2Dc->Write();


   cnvs_ex2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_col.pdf");
   ...
   TFile output_file14("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_in1.root","RECREATE");
   h1q2D1_prof->Write();
   h2q2D1_prof->Write();
   cnvs_ex2D1->Write();


   cnvs_ex2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_in1.pdf");
   ...
   TFile output_file15("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_in2.root","RECREATE");
   h1q2D2_prof->Write();
   h2q2D2_prof->Write();
   cnvs_ex2D2->Write();
   ...
   cnvs_ex2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_Az_in2.pdf");
   ...
   //   TFile* my_new_file18 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndX_col.root","RECREATE");
   // cnvs_ex->Write();
   ...
   cnvs_ey->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_in1TEST.pdf");//,"RECREATE");
   //  cnvs_ey->Write();
   ...
   TFile output_file16("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_col.root","RECREATE");
   h1r2Dc_prof->Write();
   h2r2Dc_prof->Write();
   cnvs_ey2Dc->Write();
   ...
   cnvs_ey2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_col.pdf");
   ...
   TFile output_file17("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_in1.root","RECREATE");
   h1r2D1_prof->Write();
   h2r2D1_prof->Write();
   cnvs_ey2D1->Write();


   cnvs_ey2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_in1.pdf");
   ...
   TFile output_file18("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_in2.root","RECREATE");
   h1r2D2_prof->Write();
   h2r2D2_prof->Write();
   cnvs_ey2D2->Write();
   ...
   cnvs_ey2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_Az_in2.pdf");
   ...
   //   TFile* my_new_file19 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndY_in1.root","RECREATE");
   //cnvs_ey->Write();
   ...
   cnvs_ez->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_in2TEST.pdf");//,"RECREATE");
   //   cnvs_ez->Write();
   ...
   TFile output_file19("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_col.root","RECREATE");
   h1s2Dc_prof->Write();
   h2s2Dc_prof->Write();
   cnvs_ez2Dc->Write();
   ...
   cnvs_ez2Dc->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_col.pdf");
   ...
   TFile output_file20("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_in1.root","RECREATE");
   h1s2D1_prof->Write();
   h2s2D1_prof->Write();
   cnvs_ez2D1->Write();
   ...
   cnvs_ez2D1->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_in1.pdf");
   ...
   TFile output_file21("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_in2.root","RECREATE");
   h1s2D2_prof->Write();
   h2s2D2_prof->Write();
   cnvs_ez2D2->Write();
   ...
   cnvs_ez2D2->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_Az_in2.pdf");
   ...
   //   TFile* my_new_file20 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileEndZ_in2.root","RECREATE");
   //cnvs_ez->Write();
   ...
   cnvs_ci2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_colTEST.pdf");//,"RECREATE");
   // cnvs_ci2->Write();
   ...
   TFile output_file22("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Az_col.root","RECREATE");
   h1ci02D_prof->Write();
   h2ci02D_prof->Write();
   cnvs_ci02D->Write();


   cnvs_ci02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_az_col.pdf");
   ...
   TFile output_file22z("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_col.root","RECREATE");
   hz1ci02D_prof->Write();
   hz2ci02D_prof->Write();
   cnvs_zci02D->Write();


   cnvs_zci02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_col.pdf");
   ...
   TFile output_file22p("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_col.root","RECREATE");
   hp1pi02D_prof->Write();
   hp2pi02D_prof->Write();
   cnvs_pci02D->Write();


   cnvs_pci02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_col.pdf");
   ...
   TFile output_file22p2("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_in2.root","RECREATE");
   hp1pi22Da_prof->Write();
   hp2pi22Da_prof->Write();
   cnvs_pci22D->Write();

   cnvs_pci22D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_in2.pdf");
   ...
   TFile output_file22p1("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_in1.root","RECREATE");
   hp1pi12Db_prof->Write();
   hp2pi12Db_prof->Write();
   cnvs_pci12D->Write();


   cnvs_pci12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_pitch_in1.pdf");
   ...
   legendBB2D->Draw();
   cnvs_ci12D->Update();
   TFile output_file221("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Az_in1.root","RECREATE");
   h1ci12D_prof->Write();
   h2ci12D_prof->Write();
   cnvs_ci12D->Write();
   cnvs_ci12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_az_in1.pdf");
   ...
   legendzBB2D->Draw();
   cnvs_zci12D->Update();
   TFile output_file221z("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_in1.root","RECREATE");
   hz1ci12D_prof->Write();
   hz2ci12D_prof->Write();
   cnvs_zci12D->Write();
   cnvs_zci12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_in1.pdf");
   ...
   legendAA2D->Draw();
   cnvs_ci22D->Update();
   TFile output_file2212("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Az_in2.root","RECREATE");
   h1ci22D_prof->Write();
   h2ci22D_prof->Write();
   cnvs_ci22D->Write();
   cnvs_ci22D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_az_in2.pdf");
   ...
   legendzAA2D->Draw();
   cnvs_zci22D->Update();
   TFile output_file2212z("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_in2.root","RECREATE");
   hz1ci22D_prof->Write();
   hz2ci22D_prof->Write();
   cnvs_zci22D->Write();
   cnvs_zci22D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Z_in2.pdf");
   ...
   legendFF2D->Draw();
   cnvs_wi02D->Update();
   TFile output_file22w("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Az_col.root","RECREATE");
   h1wi02D_prof->Write();
   h2wi02D_prof->Write();
   cnvs_wi02D->Write();
   cnvs_wi02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_az_col.pdf");
   ...
   legendzFF2D->Draw();
   cnvs_zwi02D->Update();
   TFile output_file22wz("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_col.root","RECREATE");
   hz1wi02D_prof->Write();
   hz2wi02D_prof->Write();
   cnvs_zwi02D->Write();
   cnvs_zwi02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_col.pdf");
   ...
   legendEE2D->Draw();
   cnvs_wi12D->Update();
   TFile output_file2211w("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Az_in1.root","RECREATE");
   h1wi12D_prof->Write();
   h2wi12D_prof->Write();
   cnvs_wi12D->Write();
   cnvs_wi12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_az_in1.pdf");
   ...
   legendzEE2D->Draw();
   cnvs_zwi12D->Update();
   TFile output_file221wz("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_in1.root","RECREATE");
   hz1wi12D_prof->Write();
   hz2wi12D_prof->Write();
   cnvs_zwi12D->Write();
   cnvs_zwi12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_in1.pdf");
   ...
   legendDD2D->Draw();
   cnvs_wi22D->Update();
   TFile output_file2212w("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Az_in2.root","RECREATE");
   h1wi22D_prof->Write();
   h2wi22D_prof->Write();
   cnvs_wi22D->Write();
   cnvs_wi22D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_az_in2.pdf");
  ...
  TCanvas* cnvs_zwi22D = new TCanvas("cnvs_zwi22D", "zwi212D", 1,1,800,700);
   ...
   legendzDD2D->Draw();
   cnvs_zwi22D->Update();
   TFile output_file222wz("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_in2.root","RECREATE");
   hz1wi22D_prof->Write();
   hz2wi22D_prof->Write();
   cnvs_zwi22D->Write();
   cnvs_zwi22D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_Z_in2.pdf");
   ...
   //   TFile* my_new_file21 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_col.root","RECREATE");
   // cnvs_ci2->Write();
   ...
   cnvs_ci1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_in1TEST.pdf");//,"RECREATE");
   //   cnvs_ci1->Write();
   ...
   */
   /*
   TFile output_file23("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Az_in1.root","RECREATE");
   h1ci12D_prof->Write();
   h2ci12D_prof->Write();
   cnvs_ci12D->Write();


   cnvs_ci12D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileInt_az_in1.pdf");
   */
   ...
   //   TFile* my_new_file22 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_in1.root","RECREATE");
   //cnvs_ci1->Write();
   /*
   ...
   cnvs_ci0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_in2TEST.pdf");//,"RECREATE");
   //   cnvs_ci0->Write();
   ...
   */
   ...
   TFile output_file24("my_output_file_2D_my_testTESToutputNUMI_tpc0_sel1_East_fileCint_Az_in2.root","RECREATE");
   h1ci02D_prof->Write();
   h2ci02D_prof->Write();
   cnvs_ci02D->Write();


   cnvs_ci02D->SaveAs("2D_my_testTESToutputNUMI_tpc0_sel1_East_fileInt_az_in2.pdf");
   ...
   */
   ...
   //   TFile* my_new_file23 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileInt_in2.root","RECREATE");
   //cnvs_ci0->Write();
   ...
   cnvs_wi2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_colTEST.pdf");//,"RECREATE");
   //  cnvs_wi2->Write();
   cout<<"wi2"<<endl;
   Double_t res_wi2[20];
   ...
   //   TFile* my_new_file24 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidt//h_col.root","RECREATE");
   //cnvs_wi2->Write();
   ...
   cnvs_wi1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_in1TEST.pdf");//,"RECREATE");
   //cnvs_wi1->Write();
   ...
   //   TFile* my_new_file25 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidt//h_in1.root","RECREATE");
   // cnvs_wi1->Write();
   ...
   cnvs_wi0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidth_in2TEST.pdf");//,"RECREATE");
   // cnvs_wi0->Write();
   ...
   //   TFile* my_new_file26 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWidt//h_in2.root","RECREATE");
   //cnvs_wi0->Write();
   ...
   cnvs_w2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_colTEST.pdf");//,"RECREATE");
   // cnvs_w2->Write();
   cout<<"w2"<<endl;
   Double_t res_w2[20];
   ...
   //   TFile* my_new_file27 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_col.root","RECREATE");
   //cnvs_w2->Write();
   ...
   cnvs_w1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_in1TEST.pdf");//,"RECREATE");
   // cnvs_w1->Write();
   cout<<"w1"<<endl;
   Double_t res_w1[20];
   ...
   //   TFile* my_new_file28 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_in1.root","RECREATE");
   //cnvs_w1->Write();
   ...
   cnvs_w0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_in2TEST.pdf");//,"RECREATE");
   //cnvs_w0->Write();
   cout<<"w0"<<endl;
   Double_t res_w0[20];
   ...
   //   TFile* my_new_file29 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileWire_in2.root","RECREATE");
   //cnvs_w0->Write();
   ...
   cnvs_ti2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_colTEST.pdf");//,"RECREATE");
   //cnvs_ti2->Write();
   ...
   //   TFile* my_new_file30 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_col.root","RECREATE");
   //cnvs_ti2->Write();
   ...
   cnvs_ti1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_in1TEST.pdf");//,"RECREATE");
   // cnvs_ti1->Write();
   ...
   //   TFile* my_new_file31 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_in1.root","RECREATE");
   //cnvs_ti1->Write();
   ...
   cnvs_ti0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_in2TEST.pdf");//,"RECREATE");
   //cnvs_ti0->Write();
   ...
   //   TFile* my_new_file32 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileTime_in2.root","RECREATE");
   //cnvs_ti0->Write();
   ...
   cnvs_x2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_colTEST.pdf");//,"RECREATE");
   //cnvs_x2->Write();
   ...
   //   TFile* my_new_file33 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_col.root","RECREATE");
   //cnvs_x2->Write();
   ...
   cnvs_x1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_in1TEST.pdf");//,"RECREATE");
   //cnvs_x1->Write();
   cout<<"x1"<<endl;
   Double_t res_x1[20];
   ...
   //   TFile* my_new_file34 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_in1.root","RECREATE");
   //cnvs_x1->Write();
   ...
   cnvs_x0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_in2TEST.pdf");//,"RECREATE");
   //cnvs_x0->Write();
   ...
   //   TFile* my_new_file35 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisy_in2.root","RECREATE");
   //cnvs_x0->Write();
   ...
   cnvs_y2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_colTEST.pdf");//,"RECREATE");
   //cnvs_y2->Write();
   cout<<"y2"<<endl;
   Double_t res_y2[20];
   ...
   //   TFile* my_new_file36 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_col.root","RECREATE");
   //cnvs_y2->Write();
   ...
   cnvs_y1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_in1TEST.pdf");//,"RECREATE");
   //cnvs_y1->Write();
   ...
   //   TFile* my_new_file37 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_in1.root","RECREATE");
   //cnvs_y1->Write();
   ...
   cnvs_y0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_in2TEST.pdf");//,"RECREATE");
   //cnvs_y0->Write();
   ...
   //   TFile* my_new_file38 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisY_in2.root","RECREATE");
   //cnvs_y0->Write();
   ...
   cnvs_z2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_colTEST.pdf");//,"RECREATE");
   //cnvs_z2->Write();
   ...
   //   TFile* my_new_file39 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_col.root","RECREATE");
   //cnvs_z2->Write();
   ...
   cnvs_z1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_in1TEST.pdf");//,"RECREATE");
   //   cnvs_z1->Write();
   ...
   //   TFile* my_new_file40 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_in1.root","RECREATE");
   //cnvs_z1->Write();
   ...
   cnvs_z0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_in2TEST.pdf");//,"RECREATE");
   // cnvs_z0->Write();
   cout<<"z0"<<endl;
   Double_t res_z0[20];
   ...
   //   TFile* my_new_file41 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_fileDisZ_in2.root","RECREATE");                                                                                          
   //cnvs_z0->Write();
   ...
   cnvs_p2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitch_colTEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
  ...
  //  cnvs_p2->Write();
   ...
   //   TFile* my_new_file42 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitc//h_col.root","RECREATE"); // open new file in write mode                                                                                         
   //cnvs_p2->Write();
   ...
   cnvs_p1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitch_in1TEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
  ...
  //  cnvs_p1->Write();
   ...
   //   TFile* my_new_file43 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitc//h_in1.root","RECREATE"); // open new file in write mode                                                                                            
   //cnvs_p1->Write();
   ...
   cnvs_p0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitch_in2TEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
   ...
   //   TFile* my_new_file44 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_sel1_East_file_Pitc//h_in2.root","RECREATE"); // open new file in write mode                                                                               
   //cnvs_p0->Write();
