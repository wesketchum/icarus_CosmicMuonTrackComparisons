...
void Between2_minus60(){
  ...
  ofstream outfile1("m60noCOSangle_by_col_E_tpc0.txt");
  ofstream outfile2("m60noCOSangle_by_in1_E_tpc0.txt");
  ofstream outfile3("m60noCOSangle_by_in2_E_tpc0.txt");
  ofstream outfile4("m60noCOSangle_by_col_W_tpc0.txt");
  ofstream outfile5("m60noCOSangle_by_in1_W_tpc0.txt");
  ofstream outfile6("m60noCOSangle_by_in2_W_tpc0.txt");
  ...
  */
  //rotation minus 60 on x-axis
  double y = 0.0;
  double z = 1.0;

  double y_p = y*TMath::Cos((Pi)/3.0) + z*TMath::Sin((Pi)/3.0);     
  double z_p = -1.0*y*TMath::Sin((Pi)/3.0) + z*TMath::Cos((Pi)/3.0);     
  


  for(int alpha = 0; alpha<aa; alpha++){

    angle_by_col_E[alpha] = TMath::ACos( ( (Y_SEL12_East_MC_col[alpha]*y_p)+ (Z_SEL12_East_MC_col[alpha]*z_p) ) / ( sqrt(X_SEL12_East_MC_col[alpha]*X_SEL12_East_MC_col[alpha]+ Y_SEL12_East_MC_col[alpha]*Y_SEL12_East_MC_col[alpha]+Z_SEL12_East_MC_col[alpha]*Z_SEL12_East_MC_col[alpha]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
  ...
  for(int beta = 0; beta<bb; beta++){
    angle_by_in1_E[beta] = TMath::ACos( ( (Y_SEL12_East_MC_in1[beta]*y_p)+ (Z_SEL12_East_MC_in1[beta]*z_p) ) / ( sqrt(X_SEL12_East_MC_in1[beta]*X_SEL12_East_MC_in1[beta]+Y_SEL12_East_MC_in1[beta]*Y_SEL12_East_MC_in1[beta]+Z_SEL12_East_MC_in1[beta]*Z_SEL12_East_MC_in1[beta]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
    ...
    for(int gamma = 0; gamma<cc; gamma++){
      angle_by_in2_E[gamma] = TMath::ACos( ( (Y_SEL12_East_MC_in2[gamma]*y_p)+ (Z_SEL12_East_MC_in2[gamma]*z_p) ) / ( sqrt(X_SEL12_East_MC_in2[gamma]*X_SEL12_East_MC_in2[gamma]+Y_SEL12_East_MC_in2[gamma]*Y_SEL12_East_MC_in2[gamma]+Z_SEL12_East_MC_in2[gamma]*Z_SEL12_East_MC_in2[gamma]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
  ...
  for(int delta = 0; delta<dd; delta++){
    ...
    angle_by_col_W[delta] = TMath::ACos( ( (Y_SEL12_West_MC_col[delta]*y_p)+ (Z_SEL12_West_MC_col[delta]*z_p) ) / ( sqrt(X_SEL12_West_MC_col[delta]*X_SEL12_West_MC_col[delta]+Y_SEL12_West_MC_col[delta]*Y_SEL12_West_MC_col[delta]+Z_SEL12_West_MC_col[delta]*Z_SEL12_West_MC_col[delta]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
  ...
  for(int zeta = 0; zeta<ee; zeta++){
    angle_by_in1_W[zeta] = TMath::ACos( ( (Y_SEL12_West_MC_in1[zeta]*y_p)+ (Z_SEL12_West_MC_in1[zeta]*z_p) ) / ( sqrt(X_SEL12_West_MC_in1[zeta]*X_SEL12_West_MC_in1[zeta]+Y_SEL12_West_MC_in1[zeta]*Y_SEL12_West_MC_in1[zeta]+Z_SEL12_West_MC_in1[zeta]*Z_SEL12_West_MC_in1[zeta]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
  ...
  for(int eta = 0; eta<ff; eta++){
    angle_by_in2_W[eta] = TMath::ACos( ( (Y_SEL12_West_MC_in2[eta]*y_p)+ (Z_SEL12_West_MC_in2[eta]*z_p) ) / ( sqrt(X_SEL12_West_MC_in2[eta]*X_SEL12_West_MC_in2[eta]+Y_SEL12_West_MC_in2[eta]*Y_SEL12_West_MC_in2[eta]+Z_SEL12_West_MC_in2[eta]*Z_SEL12_West_MC_in2[eta]) * sqrt( (y_p*y_p)+(z_p*z_p) ) ) );
  ...
  cnvs1p->SaveAs("MC_tpc0_sel12_East_file_xyz_col_angle_NEW_m60.pdf");
  cnvs2p->SaveAs("MC_tpc0_sel12_East_file_xyz_in1_angle_NEW_m60.pdf");
  cnvs3p->SaveAs("MC_tpc0_sel12_East_file_xyz_in2_angle_NEW_m60.pdf");
  cnvs4p->SaveAs("MC_tpc0_sel12_West_file_xyz_col_angle_NEW_m60.pdf");
  cnvs5p->SaveAs("MC_tpc0_sel12_West_file_xyz_in1_angle_NEW_m60.pdf");
  cnvs6p->SaveAs("MC_tpc0_sel12_West_file_xyz_in2_angle_NEW_m60.pdf");
