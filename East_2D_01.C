...
void East_2D_01(bool verbose=false) {
  ...
  ifstream ifile1("OUTFILE_mc_my_outputNUMI_tpc0_sel12_East_file_Length_Az_col.txt");
  ifstream ifile2("OUTFILE_mc_my_outputNUMI_tpc0_sel12_East_file_Cint_Az_col.txt");
  ifstream ifile3("OUTFILE_data_my_outputNUMI_tpc0_sel12_East_file_Length_Az_col.txt");
  ifstream ifile4("OUTFILE_data_my_outputNUMI_tpc0_sel12_East_file_Cint_Az_col.txt");

  ifstream ifile5("OUTFILE_mc_my_outputNUMI_tpc1_sel12_East_file_Length_Az_col.txt");
  ifstream ifile6("OUTFILE_mc_my_outputNUMI_tpc1_sel12_East_file_Cint_Az_col.txt");
  ifstream ifile7("OUTFILE_data_my_outputNUMI_tpc1_sel12_East_file_Length_Az_col.txt");
  ifstream ifile8("OUTFILE_data_my_outputNUMI_tpc1_sel12_East_file_Cint_Az_col.txt");
...
h2BB2D->Scale(1./h2BB2D->Integral());
   ...
   legendl2Dc->AddEntry(h1l2Dc_prof,"MC tpc 0");
   legendl2Dc->AddEntry(h2l2Dc_prof,"Data tpc 0");
   ...
   TFile output_file1("my_output_file_2D_my_outputNUMI_SEL12_East01_fileLength_Az_col.root","RECREATE");
   h1l2Dc_prof->Write();
   h2l2Dc_prof->Write();
   cnvs_l2Dc->Write();

   cnvs_l2Dc->SaveAs("2D_my_outputNUMI_SEL12_East01_fileLength_Az_col.pdf");
   ...
   legendAA2D->AddEntry(h1AA2D,"MC tpc 0");
   legendAA2D->AddEntry(h2AA2D,"Data tpc 0");
   ...
   TFile output_file22("my_output_file_2D_my_outputNUMI_SEL12_East01_fileCint_Az_col.root","RECREATE");
   h1ci22D_prof->Write();
   h2ci22D_prof->Write();
   cnvs_ci22D->Write();


   cnvs_ci22D->SaveAs("2D_my_outputNUMI_SEL12_East01_fileInt_az_col.pdf");
