...
void JUNE_plots_Zen(){
  ...
  h1->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  h2->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  h3->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  h4->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  h5->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  h6->GetXaxis()->SetTitle("Cosine of Zenith");
  ...
  for(int aa2 = 0; aa2<aa; aa2++){
    ...
    h1->Fill(TMath::Cos(SEL12_East_MC_col[aa2]));
  ...
  h6->Draw("HIST");
   ...
   cnvs1->SaveAs("MC_tpc3_sel12_East_file_ZenithAngle_col.pdf");

  cnvs2->SaveAs("MC_tpc3_sel12_East_file_ZenithAngle_in1.pdf");

  cnvs3->SaveAs("MC_tpc3_sel12_East_file_ZenithAngle_in2.pdf");


  cnvs4->SaveAs("MC_tpc3_sel12_West_file_ZenithAngle_col.pdf");

  cnvs5->SaveAs("MC_tpc3_sel12_West_file_ZenithAngle_in1.pdf");

  cnvs6->SaveAs("MC_tpc3_sel12_West_file_ZenithAngle_in2.pdf");
