...
void East_2D_tpc3(bool verbose=false) {

  cout<<"HERE"<<endl;
  gStyle->SetOptStat(0);

  ifstream ifile1("OUTFILE_mc_my_outputNUMI_tpc3_sel12_East_file_Length_Az_col.txt");
  ifstream ifile2("OUTFILE_mc_my_outputNUMI_tpc3_sel12_East_file_Cint_Az_col.txt");
  ifstream ifile3("OUTFILE_data_my_outputNUMI_tpc3_sel12_East_file_Length_Az_col.txt");
  ifstream ifile4("OUTFILE_data_my_outputNUMI_tpc3_sel12_East_file_Cint_Az_col.txt");
...
h2BB2D->Scale(1./h2BB2D->Integral());
   ...
   legendl2Dc->AddEntry(h1l2Dc_prof,"MC tpc 3");
   legendl2Dc->AddEntry(h2l2Dc_prof,"Data tpc 3");
   ...
   TFile output_file1("my_output_file_2D_my_outputNUMI_SEL12_East_tpc3_fileLength_Az_col.root","RECREATE");
   h1l2Dc_prof->Write();
   h2l2Dc_prof->Write();
   cnvs_l2Dc->Write();

   cnvs_l2Dc->SaveAs("2D_my_outputNUMI_SEL12_East_tpc3_fileLength_Az_col.pdf");
   ...
   legendAA2D->AddEntry(h1AA2D,"MC tpc 3");
   legendAA2D->AddEntry(h2AA2D,"Data tpc 3");
   ...
   TFile output_file22("my_output_file_2D_my_outputNUMI_SEL12_East_tpc3_fileCint_Az_col.root","RECREATE");
   h1ci22D_prof->Write();
   h2ci22D_prof->Write();
   cnvs_ci22D->Write();


   cnvs_ci22D->SaveAs("2D_my_outputNUMI_SEL12_East_tpc3_fileInt_az_col.pdf");
