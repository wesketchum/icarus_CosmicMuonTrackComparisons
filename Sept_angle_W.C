...
void Sept_angle_W(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc("mcJUNE_NUMI_tpc3_sel12_West_file_xyz_col.txt");
  ofstream outfile_in2_mc("mcJUNE_NUMI_tpc3_sel12_West_file_xyz_in2.txt");
  ofstream outfile_in1_mc("mcJUNE_NUMI_tpc3_sel12_West_file_xyz_in1.txt");

  ofstream outfile_col_data("dataJUNE_NUMI_tpc3_sel12_West_file_xyz_col.txt");
  ofstream outfile_in2_data("dataJUNE_NUMI_tpc3_sel12_West_file_xyz_in2.txt");
  ofstream outfile_in1_data("dataJUNE_NUMI_tpc3_sel12_West_file_xyz_in1.txt");
