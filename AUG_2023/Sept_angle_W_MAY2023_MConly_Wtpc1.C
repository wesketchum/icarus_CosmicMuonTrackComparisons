...
void Sept_angle_W_MAY2023_MConly_Wtpc1(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_West_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_West_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_West_file_xyz_in1.txt");

  ofstream outfile_dqdxc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_Qdx_col.txt");
  ofstream outfile_dqdx1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_Qdx_in2.txt");

  ofstream outfile_intc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_HC_col.txt");
  ofstream outfile_int1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_HC_in1.txt");
  ofstream outfile_int2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_West_file_HC_in2.txt");


  ofstream outfile1("hnoCOSangle_by_AUG2023__col_West_file_tpc1.txt");
  ofstream outfile2("hnoCOSangle_by_AUG2023__in1_West_file_tpc1.txt");
  ofstream outfile3("hnoCOSangle_by_AUG2023__in2_West_file_tpc1.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_by_AUG2023__col_West_file_tpc1_PLUS.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_by_AUG2023__in1_West_file_tpc1_PLUS.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_by_AUG2023__in2_West_file_tpc1_PLUS.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_by_AUG2023__col_West_file_tpc1_MINUS.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_by_AUG2023__in1_West_file_tpc1_MINUS.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_by_AUG2023__in2_West_file_tpc1_MINUS.txt");
  ...
  TH1F *h1P = new TH1F("h1P","TPC1 West Cryostat MC COL (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC1 West Cryostat MC COL (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC1 West Cryostat MC IN2 (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC1 West Cryostat MC IN2 (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC1 West Cryostat MC IN1 (P) ", 100., 0.0, 5.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC1 West Cryostat MC IN1 (M) ", 100., 0.0, 5.0);
  h3m->GetXaxis()->SetTitle("angle (radians)");



  TH2F *hz_hor_dQdx_East_tpc1_COL=new TH2F("hz_hor_dQdx_East_tpc1_COL","Horizontal Angle vs  dQdx COL", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc1_COL->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_dQdx_East_tpc1_IN2=new TH2F("hz_hor_dQdx_East_tpc1_IN2","Horizontal Angle vs  dQdx IN2", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc1_IN2->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_dQdx_East_tpc1_IN1=new TH2F("hz_hor_dQdx_East_tpc1_IN1","Horizontal Angle vs  dQdx IN1", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc1_IN1->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal angle in radians");

  TH2F *hz_hor_INT_East_tpc1_COL=new TH2F("hz_hor_INT_East_tpc1_COL","Horizontal Angle vs  INT COL", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc1_COL->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_INT_East_tpc1_IN2=new TH2F("hz_hor_INT_East_tpc1_IN2","Horizontal Angle vs  INT IN2", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc1_IN2->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_INT_East_tpc1_IN1=new TH2F("hz_hor_INT_East_tpc1_IN1","Horizontal Angle vs  INT IN1", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc1_IN1->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal angle in radians");


  TH2F *hz_plus_dQdx_East_tpc1_COL=new TH2F("hz_plus_dQdx_East_tpc1_COL","Horizontal plus Angle vs dQdx COL", 50., 0., 5, 50., 0., 1000.);
  hz_plus_dQdx_East_tpc1_COL->GetYaxis()->SetTitle("dQdx ");
  hz_plus_dQdx_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal plus angle in radians");
  TH2F *hz_plus_dQdx_East_tpc1_IN2=new TH2F("hz_plus_dQdx_East_tpc1_IN2","Horizontal plus Angle vs dQdx IN2", 50., 0., 5, 50., 0., 1000.);
  hz_plus_dQdx_East_tpc1_IN2->GetYaxis()->SetTitle("dQdx ");
  hz_plus_dQdx_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal plus angle in radians");
  TH2F *hz_plus_dQdx_East_tpc1_IN1=new TH2F("hz_plus_dQdx_East_tpc1_IN1","Horizontal plus Angle vs dQdx IN1", 50., 0., 5, 50., 0., 1000.);
  hz_plus_dQdx_East_tpc1_IN1->GetYaxis()->SetTitle("dQdx ");
  hz_plus_dQdx_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal plus angle in radians");

  TH2F *hz_plus_INT_East_tpc1_COL=new TH2F("hz_plus_INT_East_tpc1_COL","Horizontal plus Angle vs  INT COL", 50., 0., 5, 50., 0., 1000.);
  hz_plus_INT_East_tpc1_COL->GetYaxis()->SetTitle("INT ");
  hz_plus_INT_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal plus angle in radians");
  TH2F *hz_plus_INT_East_tpc1_IN2=new TH2F("hz_plus_INT_East_tpc1_IN2","Horizontal plus Angle vs  INT IN2", 50., 0., 5, 50., 0., 1000.);
  hz_plus_INT_East_tpc1_IN2->GetYaxis()->SetTitle("INT ");
  hz_plus_INT_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal plus angle in radians");
  TH2F *hz_plus_INT_East_tpc1_IN1=new TH2F("hz_plus_INT_East_tpc1_IN1","Horizontal plus Angle vs  INT IN1", 50., 0., 5, 50., 0., 1000.);
  hz_plus_INT_East_tpc1_IN1->GetYaxis()->SetTitle("INT ");
  hz_plus_INT_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal plus angle in radians");


  TH2F *hz_minus_dQdx_East_tpc1_COL=new TH2F("hz_minus_dQdx_East_tpc1_COL","Horizontal minus Angle vs dQdx COL", 50., -2., 3, 50., 0., 1000.);
  hz_minus_dQdx_East_tpc1_COL->GetYaxis()->SetTitle("dQdx ");
  hz_minus_dQdx_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal minus angle in radians");
  TH2F *hz_minus_dQdx_East_tpc1_IN2=new TH2F("hz_minus_dQdx_East_tpc1_IN2","Horizontal minus Angle vs dQdx IN2", 50., -2., 3, 50., 0., 1000.);
  hz_minus_dQdx_East_tpc1_IN2->GetYaxis()->SetTitle("dQdx ");
  hz_minus_dQdx_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal minus angle in radians");
  TH2F *hz_minus_dQdx_East_tpc1_IN1=new TH2F("hz_minus_dQdx_East_tpc1_IN1","Horizontal minus Angle vs dQdx IN1", 50., -2., 3, 50., 0., 1000.);
  hz_minus_dQdx_East_tpc1_IN1->GetYaxis()->SetTitle("dQdx ");
  hz_minus_dQdx_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal minus angle in radians");

  TH2F *hz_minus_INT_East_tpc1_COL=new TH2F("hz_minus_INT_East_tpc1_COL","Horizontal minus Angle vs  INT COL", 50., -2., 3, 50., 0., 1000.);
  hz_minus_INT_East_tpc1_COL->GetYaxis()->SetTitle("INT ");
  hz_minus_INT_East_tpc1_COL->GetXaxis()->SetTitle("Horizontal minus angle in radians");
  TH2F *hz_minus_INT_East_tpc1_IN2=new TH2F("hz_minus_INT_East_tpc1_IN2","Horizontal minus Angle vs  INT IN2", 50., -2., 3, 50., 0., 1000.);
  hz_minus_INT_East_tpc1_IN2->GetYaxis()->SetTitle("INT ");
  hz_minus_INT_East_tpc1_IN2->GetXaxis()->SetTitle("Horizontal minus angle in radians");
  TH2F *hz_minus_INT_East_tpc1_IN1=new TH2F("hz_minus_INT_East_tpc1_IN1","Horizontal minus Angle vs  INT IN1", 50., -2., 3, 50., 0., 1000.);
  hz_minus_INT_East_tpc1_IN1->GetYaxis()->SetTitle("INT ");
  hz_minus_INT_East_tpc1_IN1->GetXaxis()->SetTitle("Horizontal minus angle in radians");
 ...
 outfile<< "Number of files in our MC list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   while (myReader.Next()) {
	 ...
	 h1p->Fill(angle_by_col_E[alpha]);
       ...
       //ref_angle_col_p[alpha] = ref_angle_col[alpha] + TMath::Pi()/(3.0);
       //ref_angle_col_m[alpha] = ref_angle_col[alpha] - TMath::Pi()/(3.0);

       //outfile1_c_PLUS<<ref_angle_col_p[alpha]<<endl;
       //outfile1_c_MINUS<<ref_angle_col_m[alpha]<<endl;

       //h1P->Fill(ref_angle_col_p[alpha]);
       //h1m->Fill(ref_angle_col_m[alpha]);


       hz_hor_dQdx_East_tpc1_COL->Fill(ref_angle_col[alpha],av_dqdx_mc_c);
       hz_hor_INT_East_tpc1_COL->Fill(ref_angle_col[alpha],av_integral_mc_c);


       hz_plus_dQdx_East_tpc1_COL->Fill(ref_angle_col_p[alpha],av_dqdx_mc_c);
       hz_plus_INT_East_tpc1_COL->Fill(ref_angle_col_p[alpha],av_integral_mc_c);

       hz_minus_dQdx_East_tpc1_COL->Fill(ref_angle_col_m[alpha],av_dqdx_mc_c);
       hz_minus_INT_East_tpc1_COL->Fill(ref_angle_col_m[alpha],av_integral_mc_c);
	 ...
	 h3p->Fill(angle_by_in2_E[gamma]);                                                                             \
       ...
       //       ref_angle_in2_p[gamma] = ref_angle_in2[gamma] + TMath::Pi()/(3.0);
       //ref_angle_in2_m[gamma] = ref_angle_in2[gamma] - TMath::Pi()/(3.0);


       //outfile3_2_PLUS<<ref_angle_in2_p[gamma]<<endl;
       //outfile3_2_MINUS<<ref_angle_in2_m[gamma]<<endl;

       //       h2P->Fill(ref_angle_in2_p[gamma]);
       //h2m->Fill(ref_angle_in2_m[gamma]);



         hz_hor_dQdx_East_tpc1_IN2->Fill(ref_angle_in2[gamma],av_dqdx_mc_i2);
         hz_hor_INT_East_tpc1_IN2->Fill(ref_angle_in2[gamma],av_integral_mc_i2);

	 hz_plus_dQdx_East_tpc1_IN2->Fill(ref_angle_in2_p[gamma],av_dqdx_mc_i2);
         hz_plus_INT_East_tpc1_IN2->Fill(ref_angle_in2_p[gamma],av_integral_mc_i2);

	 hz_minus_dQdx_East_tpc1_IN2->Fill(ref_angle_in2_m[gamma],av_dqdx_mc_i2);
         hz_minus_INT_East_tpc1_IN2->Fill(ref_angle_in2_m[gamma],av_integral_mc_i2);
     ...
     //     ref_angle_in1_p[beta] = ref_angle_in1[beta] + TMath::Pi()/(3.0);
     //ref_angle_in1_m[beta] = ref_angle_in1[beta] - TMath::Pi()/(3.0);

     //outfile2_1_PLUS<<ref_angle_in1_p[beta]<<endl;
     //outfile2_1_MINUS<<ref_angle_in1_m[beta]<<endl;


     //h3P->Fill(ref_angle_in1_p[beta]);
     //h3m->Fill(ref_angle_in1_m[beta]);



     hz_hor_dQdx_East_tpc1_IN1->Fill(ref_angle_in1[beta],av_dqdx_mc_i1);
     hz_hor_INT_East_tpc1_IN1->Fill(ref_angle_in1[beta],av_integral_mc_i1);

        
     hz_plus_dQdx_East_tpc1_IN1->Fill(ref_angle_in1_p[beta],av_dqdx_mc_i1);
     hz_plus_INT_East_tpc1_IN1->Fill(ref_angle_in1_p[beta],av_integral_mc_i1);


     hz_minus_dQdx_East_tpc1_IN1->Fill(ref_angle_in1_m[beta],av_dqdx_mc_i1);
     hz_minus_INT_East_tpc1_IN1->Fill(ref_angle_in1_m[beta],av_integral_mc_i1);
   ...
   */
   ...
   cnvs1p->SaveAs("MC_tpc1_sel12_West_file_xyz_col_angle_NEW_h_AUG2023.pdf");
   cnvs2p->SaveAs("MC_tpc1_sel12_West_file_xyz_in1_angle_NEW_h_AUG2023.pdf");
   cnvs3p->SaveAs("MC_tpc1_sel12_West_file_xyz_in2_angle_NEW_h_AUG2023.pdf");
   ...
   cnvs1pDQ->SaveAs("MC_tpc1_sel12_West_file_xyz_col_DQDX_NEW_h_AUG2023.pdf");
   cnvs2pDQ->SaveAs("MC_tpc1_sel12_West_file_xyz_in1_DQDX_NEW_h_AUG2023.pdf");
   cnvs3pDQ->SaveAs("MC_tpc1_sel12_West_file_xyz_in2_DQDX_NEW_h_AUG2023.pdf");
   ...
   cnvs1pI->SaveAs("MC_tpc1_sel12_West_file_xyz_col_INT_NEW_h_AUG2023.pdf");
   cnvs2pI->SaveAs("MC_tpc1_sel12_West_file_xyz_in1_INT_NEW_h_AUG2023.pdf");
   cnvs3pI->SaveAs("MC_tpc1_sel12_West_file_xyz_in2_INT_NEW_h_AUG2023.pdf");
   ...
   h1m->Draw("HIST");
   cnvs1P->SaveAs("COL_MC_tpc1_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs1m->SaveAs("COL_MC_tpc1_sel12_West_file_angle_MINUS_AUG2023.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("IN2_MC_tpc1_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs2m->SaveAs("IN2_MC_tpc1_sel12_West_file_angle_MINUS_AUG2023.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("IN1_MC_tpc1_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs3m->SaveAs("IN1_MC_tpc1_sel12_West_file_angle_MINUS_AUG2023.pdf");

   TCanvas *c1 = new TCanvas("c1", "COL Profile: dqdx vs horizontal angle ",200,10,700,500);
   hz_hor_dQdx_East_tpc1_COL->Draw();
   TCanvas *c2 = new TCanvas("c2", "COL Profile: integral vs horizontal angle ",200,10,700,500);
   hz_hor_INT_East_tpc1_COL->Draw();
   c1->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c2->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");

   TCanvas *c3 = new TCanvas("c3", "IN2 Profile: dqdx vs horizontal angle ",200,10,700,500);
   hz_hor_dQdx_East_tpc1_IN2->Draw();
   TCanvas *c4 = new TCanvas("c4", "IN2 Profile: integral vs horizontal angle ",200,10,700,500);
   hz_hor_INT_East_tpc1_IN2->Draw();
   c3->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c4->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");

   TCanvas *c5 = new TCanvas("c5", "IN1 Profile: dqdx vs horizontal angle ",200,10,700,500);
   hz_hor_dQdx_East_tpc1_IN1->Draw();
   TCanvas *c6 = new TCanvas("c6", "IN1 Profile: integral vs horizontal angle ",200,10,700,500);
   hz_hor_INT_East_tpc1_IN1->Draw();
   c5->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c6->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   hz_plus_dQdx_East_tpc1_COL->Draw();
   TCanvas *c21 = new TCanvas("c21", "COL Profile: integral vs plus angle ",200,10,700,500);
   hz_plus_INT_East_tpc1_COL->Draw();
   c11->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c21->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");

   TCanvas *c31 = new TCanvas("c31", "IN2 Profile: dqdx vs plus angle ",200,10,700,500);
   hz_plus_dQdx_East_tpc1_IN2->Draw();
   TCanvas *c41 = new TCanvas("c41", "IN2 Profile: integral vs plus angle ",200,10,700,500);
   hz_plus_INT_East_tpc1_IN2->Draw();
   c31->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c41->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");

   TCanvas *c51 = new TCanvas("c51", "IN1 Profile: dqdx vs plus angle ",200,10,700,500);
   hz_plus_dQdx_East_tpc1_IN1->Draw();
   TCanvas *c61 = new TCanvas("c61", "IN1 Profile: integral vs plus angle ",200,10,700,500);
   hz_plus_INT_East_tpc1_IN1->Draw();
   c51->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c61->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");


   TCanvas *c12 = new TCanvas("c12", "COL Profile: dqdx vs minus angle ",200,10,700,500);
   hz_minus_dQdx_East_tpc1_COL->Draw();
   TCanvas *c22 = new TCanvas("c22", "COL Profile: integral vs minus angle ",200,10,700,500);
   hz_minus_INT_East_tpc1_COL->Draw();
   c12->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c22->SaveAs("COL_Profile_MC_tpc1_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");

   TCanvas *c32 = new TCanvas("c32", "IN2 Profile: dqdx vs minus angle ",200,10,700,500);
   hz_minus_dQdx_East_tpc1_IN2->Draw();
   TCanvas *c42 = new TCanvas("c42", "IN2 Profile: integral vs minus angle ",200,10,700,500);
   hz_minus_INT_East_tpc1_IN2->Draw();
   c32->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c42->SaveAs("IN2_Profile_MC_tpc1_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");

   TCanvas *c52 = new TCanvas("c52", "IN1 Profile: dqdx vs minus angle ",200,10,700,500);
   hz_minus_dQdx_East_tpc1_IN1->Draw();
   TCanvas *c62 = new TCanvas("c62", "IN1 Profile: integral vs minus angle ",200,10,700,500);
   hz_minus_INT_East_tpc1_IN1->Draw();
   c52->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c62->SaveAs("IN1_Profile_MC_tpc1_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");
