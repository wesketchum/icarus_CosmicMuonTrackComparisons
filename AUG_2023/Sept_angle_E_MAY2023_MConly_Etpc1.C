...
void Sept_angle_E_MAY2023_MConly_Etpc1(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_East_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_East_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("mcAUG2023_NUMI_tpc1_sel12_East_file_xyz_in1.txt");

  ofstream outfile_dqdxc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_in2.txt");


  ofstream outfile1("hnoCOSangle_by_AUG2023__col_East_file_tpc1.txt");
  ofstream outfile2("hnoCOSangle_by_AUG2023__in1_East_file_tpc1.txt");
  ofstream outfile3("hnoCOSangle_by_AUG2023__in2_East_file_tpc1.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_by_AUG2023__col_East_file_tpc1_PLUS.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_by_AUG2023__in1_East_file_tpc1_PLUS.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_by_AUG2023__in2_East_file_tpc1_PLUS.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_by_AUG2023__col_East_file_tpc1_MINUS.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_by_AUG2023__in1_East_file_tpc1_MINUS.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_by_AUG2023__in2_East_file_tpc1_MINUS.txt");
  ...
  TH1F *h1p = new TH1F("h1p","TPC1 East Cryostat MC (COL) ", 100., 0.0, 2.0); //0., 7.0);                             
  h1p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h2p = new TH1F("h2p","TPC1 East Cryostat MC (IN1) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                  
  h2p->GetXaxis()->SetTitle("angle in radians");

  TH1F *h3p = new TH1F("h3p","TPC1 East Cryostat MC (IN2) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                
  h3p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h1pDQ = new TH1F("h1pDQ","TPC1 East Cryostat MC (COL) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h1pDQ->GetXaxis()->SetTitle("dQ/dX");


  TH1F *h2pDQ = new TH1F("h2pDQ","TPC1 East Cryostat MC (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                                                                                                                                      
  h2pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h3pDQ = new TH1F("h3pDQ","TPC1 East Cryostat MC (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h3pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h1pI = new TH1F("h1pI","TPC1 East Cryostat MC (COL) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h1pI->GetXaxis()->SetTitle("integral");


  TH1F *h2pI = new TH1F("h2pI","TPC1 East Cryostat MC (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h2pI->GetXaxis()->SetTitle("integral");

  TH1F *h3pI = new TH1F("h3pI","TPC1 East Cryostat MC (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                   \
  ...
  TH1F *h1P = new TH1F("h1P","TPC1 East Cryostat MC COL (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC1 East Cryostat MC COL (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC1 East Cryostat MC IN2 (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC1 East Cryostat MC IN2 (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC1 East Cryostat MC IN1 (P) ", 100., 0.0, 5.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC1 East Cryostat MC IN1 (M) ", 100., 0.0, 5.0);
 ...
 outfile<< "Number of files in our MC list is " << my_files->GetNFiles() <<endl;
   ...
   */
   TCanvas* cnvs1p= new TCanvas("cnvs1p", "TPC1 East Cryostat MC COL",1,1,600,500);
   h1p->Draw("HIST");
   TCanvas* cnvs2p= new TCanvas("cnvs2p", "TPC1 East Cryostat MC IN1",1,1,600,500);
   h2p->Draw("HIST");
   TCanvas* cnvs3p= new TCanvas("cnvs3p", "TPC1 East Cryostat MC IN2",1,1,600,500);
   h3p->Draw("HIST");

   cnvs1p->SaveAs("MC_tpc1_sel12_East_file_xyz_col_angle_NEW_h_AUG2023.pdf");
   cnvs2p->SaveAs("MC_tpc1_sel12_East_file_xyz_in1_angle_NEW_h_AUG2023.pdf");
   cnvs3p->SaveAs("MC_tpc1_sel12_East_file_xyz_in2_angle_NEW_h_AUG2023.pdf");

   TCanvas* cnvs1pDQ= new TCanvas("cnvs1pDQ", "TPC1 East Cryostat MC COL",1,1,600,500);
   h1pDQ->Draw("HIST");
   TCanvas* cnvs2pDQ= new TCanvas("cnvs2pDQ", "TPC1 East Cryostat MC IN1",1,1,600,500);
   h2pDQ->Draw("HIST");
   TCanvas* cnvs3pDQ= new TCanvas("cnvs3pDQ", "TPC1 East Cryostat MC IN2",1,1,600,500);
   h3pDQ->Draw("HIST");

   cnvs1pDQ->SaveAs("MC_tpc1_sel12_East_file_xyz_col_DQDX_NEW_h_AUG2023.pdf");
   cnvs2pDQ->SaveAs("MC_tpc1_sel12_East_file_xyz_in1_DQDX_NEW_h_AUG2023.pdf");
   cnvs3pDQ->SaveAs("MC_tpc1_sel12_East_file_xyz_in2_DQDX_NEW_h_AUG2023.pdf");


   TCanvas* cnvs1pI= new TCanvas("cnvs1pI", "TPC1 East Cryostat MC COL",1,1,600,500);
   h1pI->Draw("HIST");
   TCanvas* cnvs2pI= new TCanvas("cnvs2pI", "TPC1 East Cryostat MC IN1",1,1,600,500);
   h2pI->Draw("HIST");
   TCanvas* cnvs3pI= new TCanvas("cnvs3pI", "TPC1 East Cryostat MC IN2",1,1,600,500);
   h3pI->Draw("HIST");

   cnvs1pI->SaveAs("MC_tpc1_sel12_East_file_xyz_col_INT_NEW_h_AUG2023.pdf");
   cnvs2pI->SaveAs("MC_tpc1_sel12_East_file_xyz_in1_INT_NEW_h_AUG2023.pdf");
   cnvs3pI->SaveAs("MC_tpc1_sel12_East_file_xyz_in2_INT_NEW_h_AUG2023.pdf");



   TCanvas* cnvs1P= new TCanvas("cnvs1P", "TPC1 East Cryostat MC COL Plus",1,1,600,500);
   h1P->Draw("HIST");
   TCanvas* cnvs1m= new TCanvas("cnvs1m", "TPC1 East Cryostat MC COL Minus",1,1,600,500);
   h1m->Draw("HIST");
   cnvs1P->SaveAs("COL_MC_tpc1_sel12_East_file_angle_PLUS_AUG2023.pdf");
   cnvs1m->SaveAs("COL_MC_tpc1_sel12_East_file_angle_MINUS_AUG2023.pdf");

   TCanvas* cnvs2P= new TCanvas("cnvs2P", "TPC1 East Cryostat MC IN2 Plus",1,1,600,500);
   h2P->Draw("HIST");
   TCanvas* cnvs2m= new TCanvas("cnvs2m", "TPC1 East Cryostat MC IN2 Minus",1,1,600,500);
   h2m->Draw("HIST");
   cnvs2P->SaveAs("IN2_MC_tpc1_sel12_East_file_angle_PLUS_AUG2023.pdf");
   cnvs2m->SaveAs("IN2_MC_tpc1_sel12_East_file_angle_MINUS_AUG2023.pdf");

   TCanvas* cnvs3P= new TCanvas("cnvs3p", "TPC1 East Cryostat MC IN1 Plus",1,1,600,500);
   h3P->Draw("HIST");
   TCanvas* cnvs3m= new TCanvas("cnvs3m", "TPC1 East Cryostat MC IN1 Minus",1,1,600,500);
   h3m->Draw("HIST");
   cnvs3P->SaveAs("IN1_MC_tpc1_sel12_East_file_angle_PLUS_AUG2023.pdf");
   cnvs3m->SaveAs("IN1_MC_tpc1_sel12_East_file_angle_MINUS_AUG2023.pdf");
   ...
   c1->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c2->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c3->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c4->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c5->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c6->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c11->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c21->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c31->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c41->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c51->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c61->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c12->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c22->SaveAs("COL_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_AUG2023.pdf");
   ...
   c32->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c42->SaveAs("IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_AUG2023.pdf");
   ...
   c52->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c62->SaveAs("IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_AUG2023.pdf");
