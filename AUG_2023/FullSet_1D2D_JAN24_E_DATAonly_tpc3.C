...
void FullSet_1D2D_JAN24_E_DATAonly_tpc3(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("dataOCT2023_NUMI_tpc3_sel12_East_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("dataOCT2023_NUMI_tpc3_sel12_East_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("dataOCT2023_NUMI_tpc3_sel12_East_file_xyz_in1.txt");

  ofstream outfile_dqdxc("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_East_file_HC_in2.txt");


  ofstream outfile1("datahnoCOSangle_by_OCT2023__col_East_file_tpc3.txt");
  ofstream outfile2("datahnoCOSangle_by_OCT2023__in1_East_file_tpc3.txt");
  ofstream outfile3("datahnoCOSangle_by_OCT2023__in2_East_file_tpc3.txt");

  ofstream outfile1_c_PLUS("datahnoCOSangle_by_OCT2023__col_East_file_tpc3_PLUS.txt");
  ofstream outfile2_1_PLUS("datahnoCOSangle_by_OCT2023__in1_East_file_tpc3_PLUS.txt");
  ofstream outfile3_2_PLUS("datahnoCOSangle_by_OCT2023__in2_East_file_tpc3_PLUS.txt");

  ofstream outfile1_c_MINUS("datahnoCOSangle_by_OCT2023__col_East_file_tpc3_MINUS.txt");
  ofstream outfile2_1_MINUS("datahnoCOSangle_by_OCT2023__in1_East_file_tpc3_MINUS.txt");
  ofstream outfile3_2_MINUS("datahnoCOSangle_by_OCT2023__in2_East_file_tpc3_MINUS.txt");
  ...
  TH1F *h1p = new TH1F("h1p","TPC3 East Cryostat DATA (COL) ", 100., 0.0, 2.0); //0., 7.0);                             
  h1p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h2p = new TH1F("h2p","TPC3 East Cryostat DATA (IN1) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                  
  h2p->GetXaxis()->SetTitle("angle in radians");

  TH1F *h3p = new TH1F("h3p","TPC3 East Cryostat DATA (IN2) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                
  h3p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h1pDQ = new TH1F("h1pDQ","TPC3 East Cryostat DATA (COL) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h1pDQ->GetXaxis()->SetTitle("dQ/dX");


  TH1F *h2pDQ = new TH1F("h2pDQ","TPC3 East Cryostat DATA (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                                                                                                                                      
  h2pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h3pDQ = new TH1F("h3pDQ","TPC3 East Cryostat DATA (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h3pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h1pI = new TH1F("h1pI","TPC3 East Cryostat DATA (COL) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h1pI->GetXaxis()->SetTitle("integral");


  TH1F *h2pI = new TH1F("h2pI","TPC3 East Cryostat DATA (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h2pI->GetXaxis()->SetTitle("integral");

  TH1F *h3pI = new TH1F("h3pI","TPC3 East Cryostat DATA (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                   \
  ...
  TH1F *h1P = new TH1F("h1P","TPC3 East Cryostat DATA COL (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC3 East Cryostat DATA COL (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC3 East Cryostat DATA IN2 (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC3 East Cryostat DATA IN2 (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC3 East Cryostat DATA IN1 (P) ", 100., 0.0, 2.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC3 East Cryostat DATA IN1 (M) ", 100., 0.0, 2.0);
 ...
 outfile<< "Number of files in our DATA list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   TCanvas* cnvs1p= new TCanvas("cnvs1p", "TPC3 East Cryostat DATA COL",1,1,600,500);
   h1p->Draw("HIST");
   TCanvas* cnvs2p= new TCanvas("cnvs2p", "TPC3 East Cryostat DATA IN1",1,1,600,500);
   h2p->Draw("HIST");
   TCanvas* cnvs3p= new TCanvas("cnvs3p", "TPC3 East Cryostat DATA IN2",1,1,600,500);
   h3p->Draw("HIST");

   cnvs1p->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_col_angle_NEW_h_JAN2024.pdf");
   cnvs2p->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in1_angle_NEW_h_JAN2024.pdf");
   cnvs3p->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in2_angle_NEW_h_JAN2024.pdf");

   TCanvas* cnvs1pDQ= new TCanvas("cnvs1pDQ", "TPC3 East Cryostat DATA COL",1,1,600,500);
   h1pDQ->Draw("HIST");
   TCanvas* cnvs2pDQ= new TCanvas("cnvs2pDQ", "TPC3 East Cryostat DATA IN1",1,1,600,500);
   h2pDQ->Draw("HIST");
   TCanvas* cnvs3pDQ= new TCanvas("cnvs3pDQ", "TPC3 East Cryostat DATA IN2",1,1,600,500);
   h3pDQ->Draw("HIST");

   cnvs1pDQ->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_col_DQDX_NEW_h_JAN2024.pdf");
   cnvs2pDQ->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in1_DQDX_NEW_h_JAN2024.pdf");
   cnvs3pDQ->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in2_DQDX_NEW_h_JAN2024.pdf");


   TCanvas* cnvs1pI= new TCanvas("cnvs1pI", "TPC3 East Cryostat DATA COL",1,1,600,500);
   h1pI->Draw("HIST");
   TCanvas* cnvs2pI= new TCanvas("cnvs2pI", "TPC3 East Cryostat DATA IN1",1,1,600,500);
   h2pI->Draw("HIST");
   TCanvas* cnvs3pI= new TCanvas("cnvs3pI", "TPC3 East Cryostat DATA IN2",1,1,600,500);
   h3pI->Draw("HIST");

   cnvs1pI->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_col_INT_NEW_h_JAN2024.pdf");
   cnvs2pI->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in1_INT_NEW_h_JAN2024.pdf");
   cnvs3pI->SaveAs("JAN24/DATA_tpc3_sel12_East_file_xyz_in2_INT_NEW_h_JAN2024.pdf");



   TCanvas* cnvs1P= new TCanvas("cnvs1P", "TPC3 East Cryostat DATA COL Plus",1,1,600,500);
   h1P->Draw("HIST");
   TCanvas* cnvs1m= new TCanvas("cnvs1m", "TPC3 East Cryostat DATA COL Minus",1,1,600,500);
   h1m->Draw("HIST");
   cnvs1P->SaveAs("JAN24/COL_DATA_tpc3_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs1m->SaveAs("JAN24/COL_DATA_tpc3_sel12_East_file_angle_MINUS_JAN2024.pdf");

   TCanvas* cnvs2P= new TCanvas("cnvs2P", "TPC3 East Cryostat DATA IN2 Plus",1,1,600,500);
   h2P->Draw("HIST");
   TCanvas* cnvs2m= new TCanvas("cnvs2m", "TPC3 East Cryostat DATA IN2 Minus",1,1,600,500);
   h2m->Draw("HIST");
   cnvs2P->SaveAs("JAN24/IN2_DATA_tpc3_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs2m->SaveAs("JAN24/IN2_DATA_tpc3_sel12_East_file_angle_MINUS_JAN2024.pdf");

   TCanvas* cnvs3P= new TCanvas("cnvs3p", "TPC3 East Cryostat DATA IN1 Plus",1,1,600,500);
   h3P->Draw("HIST");
   TCanvas* cnvs3m= new TCanvas("cnvs3m", "TPC3 East Cryostat DATA IN1 Minus",1,1,600,500);
   h3m->Draw("HIST");
   cnvs3P->SaveAs("JAN24/IN1_DATA_tpc3_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs3m->SaveAs("JAN24/IN1_DATA_tpc3_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   c1->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c2->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c3->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c4->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c5->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c6->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c11->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c21->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c31->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c41->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c51->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c61->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c12->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c22->SaveAs("JAN24/COL_Profile_DATA_tpc3_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c32->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c42->SaveAs("JAN24/IN2_Profile_DATA_tpc3_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c52->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c62->SaveAs("JAN24/IN1_Profile_DATA_tpc3_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
