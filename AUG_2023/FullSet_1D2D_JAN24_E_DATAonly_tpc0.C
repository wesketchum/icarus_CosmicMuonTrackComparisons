...
void FullSet_1D2D_JAN24_E_DATAonly_tpc0(bool verbose=false) {
  ...
  ofstream outfile_dqdxc("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_in2.txt");


  ofstream outfile1("hnoCOSangle_by_OCT2023__col_East_file_tpc0.txt");
  ofstream outfile2("hnoCOSangle_by_OCT2023__in1_East_file_tpc0.txt");
  ofstream outfile3("hnoCOSangle_by_OCT2023__in2_East_file_tpc0.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_by_OCT2023__col_East_file_tpc0_PLUS.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_by_OCT2023__in1_East_file_tpc0_PLUS.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_by_OCT2023__in2_East_file_tpc0_PLUS.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_by_OCT2023__col_East_file_tpc0_MINUS.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_by_OCT2023__in1_East_file_tpc0_MINUS.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_by_OCT2023__in2_East_file_tpc0_MINUS.txt");
  ...
  my_files->AddFromFile("DATA24.TXT");///pnfs/sbn/data/sbn_fd/poms_production/data/Run2/reconstructed/icaruscode_v09_72_00_03p01/bnbmajority/calibtuples/00/00/**/**/");//mc_april22versiontest2.txt");//mc_aprilversion.txt");
 outfile<< "Number of files in our DATA list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   cnvs1p->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_col_angle_NEW_h_JAN2024.pdf");
   cnvs2p->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in1_angle_NEW_h_JAN2024.pdf");
   cnvs3p->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in2_angle_NEW_h_JAN2024.pdf");
   ...
   cnvs1pDQ->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_col_DQDX_NEW_h_JAN2024.pdf");
   cnvs2pDQ->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in1_DQDX_NEW_h_JAN2024.pdf");
   cnvs3pDQ->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in2_DQDX_NEW_h_JAN2024.pdf");
   ...
   cnvs1pI->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_col_INT_NEW_h_JAN2024.pdf");
   cnvs2pI->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in1_INT_NEW_h_JAN2024.pdf");
   cnvs3pI->SaveAs("JAN24/DATA_tpc0_sel12_East_file_xyz_in2_INT_NEW_h_JAN2024.pdf");
   ...
   h1m->Draw("HIST");
   cnvs1P->SaveAs("JAN24/COL_DATA_tpc0_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs1m->SaveAs("JAN24/COL_DATA_tpc0_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("JAN24/IN2_DATA_tpc0_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs2m->SaveAs("JAN24/IN2_DATA_tpc0_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("JAN24/IN1_DATA_tpc0_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs3m->SaveAs("JAN24/IN1_DATA_tpc0_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   c1->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c2->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c3->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c4->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c5->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c6->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c11->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c21->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c31->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c41->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c51->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c61->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c12->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c22->SaveAs("JAN24/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c32->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c42->SaveAs("JAN24/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c52->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c62->SaveAs("JAN24/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
