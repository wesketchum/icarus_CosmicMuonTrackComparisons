...
void FullSet_1D2D_JAN24_W_MCDATA_tpc3(bool verbose=false) {


  gStyle->SetOptStat(0);

  ofstream outfile_dqdxc("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_Qdx_col_MCvsDATA.txt");
  ofstream outfile_dqdx1("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_Qdx_in1_MCvsDATA.txt");
  ofstream outfile_dqdx2("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_Qdx_in2_MCvsDATA.txt");

  ofstream outfile_intc("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_HC_col_MCvsDATA.txt");
  ofstream outfile_int1("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_HC_in1_MCvsDATA.txt");
  ofstream outfile_int2("FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_HC_in2_MCvsDATA.txt");



  ofstream outfile1("hnoCOSangle_FEB24_col_West_file_tpc3_MCvsDATA.txt");
  ofstream outfile2("hnoCOSangle_FEB24_in1_West_file_tpc3_MCvsDATA.txt");
  ofstream outfile3("hnoCOSangle_FEB24_in2_West_file_tpc3_MCvsDATA.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_FEB24_col_West_file_tpc3_PLUS_MCvsDATA.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_FEB24_in1_West_file_tpc3_PLUS_MCvsDATA.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_FEB24_in2_West_file_tpc3_PLUS_MCvsDATA.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_FEB24_col_West_file_tpc3_MINUS_MCvsDATA.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_FEB24_in1_West_file_tpc3_MINUS_MCvsDATA.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_FEB24_in2_West_file_tpc3_MINUS_MCvsDATA.txt");

  ifstream infiledqdxc_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_col.txt");
  ifstream infiledqdx2_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in2.txt");
  ifstream infiledqdx1_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in1.txt");
  ifstream infileintc_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_col.txt");
  ifstream infileint2_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in2.txt");
  ifstream infileint1_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in1.txt");

  ifstream infileAc_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc3.txt");
  ifstream infileA2_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc3.txt");
  ifstream infileA1_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc3.txt");
  ifstream infileAcp_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc3_PLUS.txt");
  ifstream infileA2p_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc3_PLUS.txt");
  ifstream infileA1p_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc3_PLUS.txt");
  ifstream infileAcm_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc3_MINUS.txt");
  ifstream infileA2m_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc3_MINUS.txt");
  ifstream infileA1m_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc3_MINUS.txt");


  ifstream infiledqdxc_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_col.txt");
  ifstream infiledqdx2_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in2.txt");
  ifstream infiledqdx1_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in1.txt");
  ifstream infileintc_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_col.txt");
  ifstream infileint2_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in2.txt");
  ifstream infileint1_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in1.txt");

  ifstream infileAc_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc3.txt");
  ifstream infileA2_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc3.txt");
  ifstream infileA1_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc3.txt");
  ifstream infileAcp_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc3_PLUS.txt");
  ifstream infileA2p_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc3_PLUS.txt");
  ifstream infileA1p_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc3_PLUS.txt");
  ifstream infileAcm_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc3_MINUS.txt");
  ifstream infileA2m_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc3_MINUS.txt");
  ifstream infileA1m_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc3_MINUS.txt");
  ...
  //display
   ...
   legendAc->Draw();
   cnvs_Ac->Update();
   cnvs_Ac->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_col_MCvsDATA.pdf");
   ...
   legendA1->Draw();
   cnvs_A1->Update();
   cnvs_A1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in1_MCvsDATA.pdf");
   ...
   legendA2->Draw();
   cnvs_A2->Update();
   cnvs_A2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in2_MCvsDATA.pdf");
   ...
   legendAcp->Draw();
   cnvs_Acp->Update();
   cnvs_Acp->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_col_plus_MCvsDATA.pdf");
   ...
   legendA1p->Draw();
   cnvs_A1p->Update();
   cnvs_A1p->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in1_plus_MCvsDATA.pdf");
   ...
   legendA2p->Draw();
   cnvs_A2p->Update();
   cnvs_A2p->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in2_plus_MCvsDATA.pdf");
   ...
   legendAcm->Draw();
   cnvs_Acm->Update();
   cnvs_Acm->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_col_minus_MCvsDATA.pdf");
   ...
   legendA1m->Draw();
   cnvs_A1m->Update();
   cnvs_A1m->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in1_minus_MCvsDATA.pdf");
   ...
   legendA2m->Draw();
   cnvs_A2m->Update();
   cnvs_A2m->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_angle_in2_minus_MCvsDATA.pdf");
   ...
   legendDQDXc->Draw();
   cnvs_DQDXc->Update();
   cnvs_DQDXc->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_DQDX_col_MCvsDATA.pdf");
   ...
   legendDQDX1->Draw();
   cnvs_DQDX1->Update();
   cnvs_DQDX1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_DQDX_in1_MCvsDATA.pdf");
   ...
   legendDQDX2->Draw();
   cnvs_DQDX2->Update();
   cnvs_DQDX2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_DQDX_in2_MCvsDATA.pdf");
   ...
   legendINTc->Draw();
   cnvs_INTc->Update();
   cnvs_INTc->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_INT_col_MCvsDATA.pdf");
   ...
   legendINT1->Draw();
   cnvs_INT1->Update();
   cnvs_INT1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_INT_in1_MCvsDATA.pdf");
   ...
   legendINT2->Draw();
   cnvs_INT2->Update();
   cnvs_INT2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc3_sel12_West_file_INT_in2_MCvsDATA.pdf");
