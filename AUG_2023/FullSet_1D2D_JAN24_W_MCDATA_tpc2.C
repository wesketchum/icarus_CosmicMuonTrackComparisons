...
void FullSet_1D2D_JAN24_W_MCDATA_tpc2(bool verbose=false) {


  gStyle->SetOptStat(0);

  ofstream outfile_dqdxc("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_Qdx_col_MCvsDATA.txt");
  ofstream outfile_dqdx1("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_Qdx_in1_MCvsDATA.txt");
  ofstream outfile_dqdx2("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_Qdx_in2_MCvsDATA.txt");

  ofstream outfile_intc("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_HC_col_MCvsDATA.txt");
  ofstream outfile_int1("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_HC_in1_MCvsDATA.txt");
  ofstream outfile_int2("FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_HC_in2_MCvsDATA.txt");



  ofstream outfile1("hnoCOSangle_FEB24_col_West_file_tpc2_MCvsDATA.txt");
  ofstream outfile2("hnoCOSangle_FEB24_in1_West_file_tpc2_MCvsDATA.txt");
  ofstream outfile3("hnoCOSangle_FEB24_in2_West_file_tpc2_MCvsDATA.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_FEB24_col_West_file_tpc2_PLUS_MCvsDATA.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_FEB24_in1_West_file_tpc2_PLUS_MCvsDATA.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_FEB24_in2_West_file_tpc2_PLUS_MCvsDATA.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_FEB24_col_West_file_tpc2_MINUS_MCvsDATA.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_FEB24_in1_West_file_tpc2_MINUS_MCvsDATA.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_FEB24_in2_West_file_tpc2_MINUS_MCvsDATA.txt");

  ifstream infiledqdxc_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_col.txt");
  ifstream infiledqdx2_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_in2.txt");
  ifstream infiledqdx1_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_in1.txt");
  ifstream infileintc_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_col.txt");
  ifstream infileint2_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_in2.txt");
  ifstream infileint1_DATA("dataOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_in1.txt");

  ifstream infileAc_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc2.txt");
  ifstream infileA2_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc2.txt");
  ifstream infileA1_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc2.txt");
  ifstream infileAcp_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc2_PLUS.txt");
  ifstream infileA2p_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc2_PLUS.txt");
  ifstream infileA1p_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc2_PLUS.txt");
  ifstream infileAcm_DATA("datahnoCOSangle_by_OCT2023__col_West_file_tpc2_MINUS.txt");
  ifstream infileA2m_DATA("datahnoCOSangle_by_OCT2023__in2_West_file_tpc2_MINUS.txt");
  ifstream infileA1m_DATA("datahnoCOSangle_by_OCT2023__in1_West_file_tpc2_MINUS.txt");


  ifstream infiledqdxc_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_col.txt");
  ifstream infiledqdx2_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_in2.txt");
  ifstream infiledqdx1_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_Qdx_in1.txt");
  ifstream infileintc_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_col.txt");
  ifstream infileint2_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_in2.txt");
  ifstream infileint1_MC("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_West_file_HC_in1.txt");

  ifstream infileAc_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc2.txt");
  ifstream infileA2_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc2.txt");
  ifstream infileA1_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc2.txt");
  ifstream infileAcp_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc2_PLUS.txt");
  ifstream infileA2p_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc2_PLUS.txt");
  ifstream infileA1p_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc2_PLUS.txt");
  ifstream infileAcm_MC("mchnoCOSangle_by_OCT2023__col_West_file_tpc2_MINUS.txt");
  ifstream infileA2m_MC("mchnoCOSangle_by_OCT2023__in2_West_file_tpc2_MINUS.txt");
  ifstream infileA1m_MC("mchnoCOSangle_by_OCT2023__in1_West_file_tpc2_MINUS.txt");
  ...
  TH1F *h_Ac_mc   = new TH1F("h_Ac_mc","Relative Frequency vs  Horizontal Angle: West Cryostat", 100., 0., 2.);
  TH1F *h_Ac_data = new TH1F("h_Ac_data","Relative Frequency vs Horizontal Angle: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A1_mc   = new TH1F("h_A1_mc","Relative Frequency vs  Horizontal Angle: West Cryostat", 100., 0., 2.);
  TH1F *h_A1_data = new TH1F("h_A1_data","Relative Frequency vs Horizontal Angle: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A2_mc   = new TH1F("h_A2_mc","Relative Frequency vs  Horizontal Angle: West Cryostat", 100., 0., 2.);
  TH1F *h_A2_data = new TH1F("h_A2_data","Relative Frequency vs Horizontal Angle: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_Acp_mc   = new TH1F("h_Acp_mc","Relative Frequency vs  Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  TH1F *h_Acp_data = new TH1F("h_Acp_data","Relative Frequency vs Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A1p_mc   = new TH1F("h_A1p_mc","Relative Frequency vs  Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  TH1F *h_A1p_data = new TH1F("h_A1p_data","Relative Frequency vs Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A2p_mc   = new TH1F("h_A2p_mc","Relative Frequency vs  Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  TH1F *h_A2p_data = new TH1F("h_A2p_data","Relative Frequency vs Horizontal Angle PLUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_Acm_mc   = new TH1F("h_Acm_mc","Relative Frequency vs  Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  TH1F *h_Acm_data = new TH1F("h_Acm_data","Relative Frequency vs Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A1m_mc   = new TH1F("h_A1m_mc","Relative Frequency vs  Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  TH1F *h_A1m_data = new TH1F("h_A1m_data","Relative Frequency vs Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_A2m_mc   = new TH1F("h_A2m_mc","Relative Frequency vs  Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  TH1F *h_A2m_data = new TH1F("h_A2m_data","Relative Frequency vs Horizontal Angle MINUS: West Cryostat", 100., 0., 2.);
  ...
  TH1F *h_dqdxc_mc   = new TH1F("h_dqdxc_mc","Relative Frequency vs  DQDX: West Cryostat", 100., 0., 2000.);
  TH1F *h_dqdxc_data = new TH1F("h_dqdxc_data","Relative Frequency vs  DQDX: West Cryostat", 100., 0., 2000.);
  h_dqdxc_mc->GetXaxis()->SetTitle(" DQDX ");
  h_dqdxc_mc->GetYaxis()->SetTitle("Relative Frequency");
  THStack *hs_dqdxc = new THStack("hs_dqdxc","");
  TH1F *h_dqdx1_mc   = new TH1F("h_dqdx1_mc","Relative Frequency vs   DQDX: West Cryostat", 100., 0., 2000.);
  TH1F *h_dqdx1_data = new TH1F("h_dqdx1_data","Relative Frequency vs  DQDX: West Cryostat", 100., 0., 2000.);
  h_dqdx1_mc->GetXaxis()->SetTitle(" DQDX ");
  h_dqdx1_mc->GetYaxis()->SetTitle("Relative Frequency");
  THStack *hs_dqdx1 = new THStack("hs_dqdx1","");
  TH1F *h_dqdx2_mc   = new TH1F("h_dqdx2_mc","Relative Frequency vs   DQDX: West Cryostat", 100., 0., 2000.);
  TH1F *h_dqdx2_data = new TH1F("h_dqdx2_data","Relative Frequency vs  DQDX: West Cryostat", 100., 0., 2000.);
  h_dqdx2_mc->GetXaxis()->SetTitle(" DQDX ");
  h_dqdx2_mc->GetYaxis()->SetTitle("Relative Frequency");
  THStack *hs_dqdx2 = new THStack("hs_dqdx2","");

  TH1F *h_intc_mc   = new TH1F("h_intc_mc","Relative Frequency vs  INT: West Cryostat", 100., 0., 2000.);
  TH1F *h_intc_data = new TH1F("h_intc_data","Relative Frequency vs  INT: West Cryostat", 100., 0., 2000.);
  h_intc_mc->GetXaxis()->SetTitle(" INT ");
  h_intc_mc->GetYaxis()->SetTitle("Relative Frequency");
  THStack *hs_intc = new THStack("hs_intc","");
  TH1F *h_int1_mc   = new TH1F("h_int1_mc","Relative Frequency vs   INT: West Cryostat", 100., 0., 2000.);
  TH1F *h_int1_data = new TH1F("h_int1_data","Relative Frequency vs  INT: West Cryostat", 100., 0., 2000.);
  h_int1_mc->GetXaxis()->SetTitle(" INT ");
  h_int1_mc->GetYaxis()->SetTitle("Relative Frequency");
  THStack *hs_int1 = new THStack("hs_int1","");
  TH1F *h_int2_mc   = new TH1F("h_int2_mc","Relative Frequency vs   INT: West Cryostat", 100., 0., 2000.);
  TH1F *h_int2_data = new TH1F("h_int2_data","Relative Frequency vs  INT: West Cryostat", 100., 0., 2000.);
  ...
  //display
   ...
   TAc.DrawTextNDC(.5,.95,"Relative Frequency vs Horizontal Angle (col): West Cryostat");
   auto legendAc = new TLegend(0.1,0.8,0.2,0.9);
   legendAc->AddEntry(h1Ac,"MC");
   legendAc->AddEntry(h2Ac,"Data");
   legendAc->Draw();
   cnvs_Ac->Update();
   cnvs_Ac->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_col_MCvsDATA.pdf");
   ...
   TA1.DrawTextNDC(.5,.95,"Relative Frequency vs Horizontal Angle (in1): West Cryostat");
   auto legendA1 = new TLegend(0.1,0.8,0.2,0.9);
   legendA1->AddEntry(h1A1,"MC");
   legendA1->AddEntry(h2A1,"Data");
   legendA1->Draw();
   cnvs_A1->Update();
   cnvs_A1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in1_MCvsDATA.pdf");
   ...
   TA2.DrawTextNDC(.5,.95,"Relative Frequency vs Horizontal Angle (in2): West Cryostat");
   auto legendA2 = new TLegend(0.1,0.8,0.2,0.9);
   legendA2->AddEntry(h1A2,"MC");
   legendA2->AddEntry(h2A2,"Data");
   legendA2->Draw();
   cnvs_A2->Update();
   cnvs_A2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in2_MCvsDATA.pdf");
   ...
   legendAcp->Draw();
   cnvs_Acp->Update();
   cnvs_Acp->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_col_plus_MCvsDATA.pdf");
   ...
   legendA1p->Draw();
   cnvs_A1p->Update();
   cnvs_A1p->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in1_plus_MCvsDATA.pdf");
   ...
   legendA2p->Draw();
   cnvs_A2p->Update();
   cnvs_A2p->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in2_plus_MCvsDATA.pdf");
   ...
   legendAcm->Draw();
   cnvs_Acm->Update();
   cnvs_Acm->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_col_minus_MCvsDATA.pdf");
   ...
   legendA1m->Draw();
   cnvs_A1m->Update();
   cnvs_A1m->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in1_minus_MCvsDATA.pdf");
   ...
   legendA2m->Draw();
   cnvs_A2m->Update();
   cnvs_A2m->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_angle_in2_minus_MCvsDATA.pdf");
   ...
   TDQDXc.DrawTextNDC(.5,.95,"Relative Frequency vs DQDX (col): West Cryostat");
   auto legendDQDXc = new TLegend(0.1,0.8,0.2,0.9);
   legendDQDXc->AddEntry(h1DQDXc,"MC");
   legendDQDXc->AddEntry(h2DQDXc,"Data");
   legendDQDXc->Draw();
   cnvs_DQDXc->Update();
   cnvs_DQDXc->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_DQDX_col_MCvsDATA.pdf");
   ...
   TDQDX1.DrawTextNDC(.5,.95,"Relative Frequency vs DQDX (in1): West Cryostat");
   auto legendDQDX1 = new TLegend(0.1,0.8,0.2,0.9);
   legendDQDX1->AddEntry(h1DQDX1,"MC");
   legendDQDX1->AddEntry(h2DQDX1,"Data");
   legendDQDX1->Draw();
   cnvs_DQDX1->Update();
   cnvs_DQDX1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_DQDX_in1_MCvsDATA.pdf");
   ...
   TDQDX2.DrawTextNDC(.5,.95,"Relative Frequency vs DQDX (in2): West Cryostat");
   auto legendDQDX2 = new TLegend(0.1,0.8,0.2,0.9);
   legendDQDX2->AddEntry(h1DQDX2,"MC");
   legendDQDX2->AddEntry(h2DQDX2,"Data");
   legendDQDX2->Draw();
   cnvs_DQDX2->Update();
   cnvs_DQDX2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_DQDX_in2_MCvsDATA.pdf");
   ...
   TINTc.DrawTextNDC(.5,.95,"Relative Frequency vs INT (col): West Cryostat");
   auto legendINTc = new TLegend(0.1,0.8,0.2,0.9);
   legendINTc->AddEntry(h1INTc,"MC");
   legendINTc->AddEntry(h2INTc,"Data");
   legendINTc->Draw();
   cnvs_INTc->Update();
   cnvs_INTc->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_INT_col_MCvsDATA.pdf");
   ...
   TINT1.DrawTextNDC(.5,.95,"Relative Frequency vs INT (in1): West Cryostat");
   auto legendINT1 = new TLegend(0.1,0.8,0.2,0.9);
   legendINT1->AddEntry(h1INT1,"MC");
   legendINT1->AddEntry(h2INT1,"Data");
   legendINT1->Draw();
   cnvs_INT1->Update();
   cnvs_INT1->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_INT_in1_MCvsDATA.pdf");
   ...
   TINT2.DrawTextNDC(.5,.95,"Relative Frequency vs INT (in2): West Cryostat");
   auto legendINT2 = new TLegend(0.1,0.8,0.2,0.9);
   legendINT2->AddEntry(h1INT2,"MC");
   legendINT2->AddEntry(h2INT2,"Data");
   legendINT2->Draw();
   cnvs_INT2->Update();
   cnvs_INT2->SaveAs("JAN24/FEB24_OUTFILE_NUMI_tpc2_sel12_West_file_INT_in2_MCvsDATA.pdf");
