...
void FullSet_1D2D_Oct23_E_MConly_Etpc2(bool verbose=false) {
  ...
  ofstream outfile_dqdxc("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("OCT2023_OUTFILE_my_testTESToutputNUMI_tpc2_sel12_East_file_HC_in2.txt");


  ofstream outfile1("hnoCOSangle_by_OCT2023__col_East_file_tpc2.txt");
  ofstream outfile2("hnoCOSangle_by_OCT2023__in1_East_file_tpc2.txt");
  ofstream outfile3("hnoCOSangle_by_OCT2023__in2_East_file_tpc2.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_by_OCT2023__col_East_file_tpc2_PLUS.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_by_OCT2023__in1_East_file_tpc2_PLUS.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_by_OCT2023__in2_East_file_tpc2_PLUS.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_by_OCT2023__col_East_file_tpc2_MINUS.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_by_OCT2023__in1_East_file_tpc2_MINUS.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_by_OCT2023__in2_East_file_tpc2_MINUS.txt");
 ...
 outfile<< "Number of files in our MC list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   cnvs1p->SaveAs("MC_tpc2_sel12_East_file_xyz_col_angle_NEW_h_OCT2023.pdf");
   cnvs2p->SaveAs("MC_tpc2_sel12_East_file_xyz_in1_angle_NEW_h_OCT2023.pdf");
   cnvs3p->SaveAs("MC_tpc2_sel12_East_file_xyz_in2_angle_NEW_h_OCT2023.pdf");
   ...
   cnvs1pDQ->SaveAs("MC_tpc2_sel12_East_file_xyz_col_DQDX_NEW_h_OCT2023.pdf");
   cnvs2pDQ->SaveAs("MC_tpc2_sel12_East_file_xyz_in1_DQDX_NEW_h_OCT2023.pdf");
   cnvs3pDQ->SaveAs("MC_tpc2_sel12_East_file_xyz_in2_DQDX_NEW_h_OCT2023.pdf");
   ...
   cnvs1pI->SaveAs("MC_tpc2_sel12_East_file_xyz_col_INT_NEW_h_OCT2023.pdf");
   cnvs2pI->SaveAs("MC_tpc2_sel12_East_file_xyz_in1_INT_NEW_h_OCT2023.pdf");
   cnvs3pI->SaveAs("MC_tpc2_sel12_East_file_xyz_in2_INT_NEW_h_OCT2023.pdf");
   ...
   h1m->Draw("HIST");
   cnvs1P->SaveAs("COL_MC_tpc2_sel12_East_file_angle_PLUS_OCT2023.pdf");
   cnvs1m->SaveAs("COL_MC_tpc2_sel12_East_file_angle_MINUS_OCT2023.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("IN2_MC_tpc2_sel12_East_file_angle_PLUS_OCT2023.pdf");
   cnvs2m->SaveAs("IN2_MC_tpc2_sel12_East_file_angle_MINUS_OCT2023.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("IN1_MC_tpc2_sel12_East_file_angle_PLUS_OCT2023.pdf");
   cnvs3m->SaveAs("IN1_MC_tpc2_sel12_East_file_angle_MINUS_OCT2023.pdf");
   ...
   c1->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_dqdx_VS_horizontalAngle_OCT2023.pdf");
   c2->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_integral_VS_horizontalAngle_OCT2023.pdf");
   ...
   c3->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_dqdx_VS_horizontalAngle_OCT2023.pdf");
   c4->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_integral_VS_horizontalAngle_OCT2023.pdf");
   ...
   c5->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_dqdx_VS_horizontalAngle_OCT2023.pdf");
   c6->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_integral_VS_horizontalAngle_OCT2023.pdf");
   ...
   c11->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_dqdx_VS_plusAngle_OCT2023.pdf");
   c21->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_integral_VS_plusAngle_OCT2023.pdf");
   ...
   c31->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_dqdx_VS_plusAngle_OCT2023.pdf");
   c41->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_integral_VS_plusAngle_OCT2023.pdf");
   ...
   c51->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_dqdx_VS_plusAngle_OCT2023.pdf");
   c61->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_integral_VS_plusAngle_OCT2023.pdf");
   ...
   c12->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_dqdx_VS_minusAngle_OCT2023.pdf");
   c22->SaveAs("COL_Profile_MC_tpc2_sel12_East_file_integral_VS_minusAngle_OCT2023.pdf");
   ...
   c32->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_dqdx_VS_minusAngle_OCT2023.pdf");
   c42->SaveAs("IN2_Profile_MC_tpc2_sel12_East_file_integral_VS_minusAngle_OCT2023.pdf");
   ...
   c52->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_dqdx_VS_minusAngle_OCT2023.pdf");
   c62->SaveAs("IN1_Profile_MC_tpc2_sel12_East_file_integral_VS_minusAngle_OCT2023.pdf");
