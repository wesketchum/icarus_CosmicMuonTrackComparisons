...
void FullSet_1D2D_JAN24_E_MConly_tpc1(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("mcOCT2023_NUMI_tpc1_sel12_East_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("mcOCT2023_NUMI_tpc1_sel12_East_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("mcOCT2023_NUMI_tpc1_sel12_East_file_xyz_in1.txt");

  ofstream outfile_dqdxc("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("mcOCT2023_OUTFILE_my_testTESToutputNUMI_tpc1_sel12_East_file_HC_in2.txt");


  ofstream outfile1("mchnoCOSangle_by_OCT2023__col_East_file_tpc1.txt");
  ofstream outfile2("mchnoCOSangle_by_OCT2023__in1_East_file_tpc1.txt");
  ofstream outfile3("mchnoCOSangle_by_OCT2023__in2_East_file_tpc1.txt");

  ofstream outfile1_c_PLUS("mchnoCOSangle_by_OCT2023__col_East_file_tpc1_PLUS.txt");
  ofstream outfile2_1_PLUS("mchnoCOSangle_by_OCT2023__in1_East_file_tpc1_PLUS.txt");
  ofstream outfile3_2_PLUS("mchnoCOSangle_by_OCT2023__in2_East_file_tpc1_PLUS.txt");

  ofstream outfile1_c_MINUS("mchnoCOSangle_by_OCT2023__col_East_file_tpc1_MINUS.txt");
  ofstream outfile2_1_MINUS("mchnoCOSangle_by_OCT2023__in1_East_file_tpc1_MINUS.txt");
  ofstream outfile3_2_MINUS("mchnoCOSangle_by_OCT2023__in2_East_file_tpc1_MINUS.txt");
  ...
  TH1F *h1P = new TH1F("h1P","TPC1 East Cryostat MC COL (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC1 East Cryostat MC COL (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC1 East Cryostat MC IN2 (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC1 East Cryostat MC IN2 (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC1 East Cryostat MC IN1 (P) ", 100., 0.0, 2.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC1 East Cryostat MC IN1 (M) ", 100., 0.0, 2.0);
 ...
 outfile<< "Number of files in our MC list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   cnvs1p->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_col_angle_NEW_h_JAN2024.pdf");
   cnvs2p->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in1_angle_NEW_h_JAN2024.pdf");
   cnvs3p->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in2_angle_NEW_h_JAN2024.pdf");
   ...
   cnvs1pDQ->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_col_DQDX_NEW_h_JAN2024.pdf");
   cnvs2pDQ->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in1_DQDX_NEW_h_JAN2024.pdf");
   cnvs3pDQ->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in2_DQDX_NEW_h_JAN2024.pdf");
   ...
   cnvs1pI->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_col_INT_NEW_h_JAN2024.pdf");
   cnvs2pI->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in1_INT_NEW_h_JAN2024.pdf");
   cnvs3pI->SaveAs("JAN24/MC_tpc1_sel12_East_file_xyz_in2_INT_NEW_h_JAN2024.pdf");
   ...
   h1m->Draw("HIST");
   cnvs1P->SaveAs("JAN24/COL_MC_tpc1_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs1m->SaveAs("JAN24/COL_MC_tpc1_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("JAN24/IN2_MC_tpc1_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs2m->SaveAs("JAN24/IN2_MC_tpc1_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("JAN24/IN1_MC_tpc1_sel12_East_file_angle_PLUS_JAN2024.pdf");
   cnvs3m->SaveAs("JAN24/IN1_MC_tpc1_sel12_East_file_angle_MINUS_JAN2024.pdf");
   ...
   c1->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c2->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c3->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c4->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c5->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_horizontalAngle_JAN2024.pdf");
   c6->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_horizontalAngle_JAN2024.pdf");
   ...
   c11->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c21->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c31->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c41->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c51->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_plusAngle_JAN2024.pdf");
   c61->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_plusAngle_JAN2024.pdf");
   ...
   c12->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c22->SaveAs("JAN24/COL_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c32->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c42->SaveAs("JAN24/IN2_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
   ...
   c52->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_dqdx_VS_minusAngle_JAN2024.pdf");
   c62->SaveAs("JAN24/IN1_Profile_MC_tpc1_sel12_East_file_integral_VS_minusAngle_JAN2024.pdf");
