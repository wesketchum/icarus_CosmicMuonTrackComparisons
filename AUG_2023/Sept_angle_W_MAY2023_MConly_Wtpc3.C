...
void Sept_angle_W_MAY2023_MConly_Wtpc3(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("mcAUG2023_NUMI_tpc3_sel12_West_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("mcAUG2023_NUMI_tpc3_sel12_West_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("mcAUG2023_NUMI_tpc3_sel12_West_file_xyz_in1.txt");

  ofstream outfile_dqdxc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_col.txt");
  ofstream outfile_dqdx1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_Qdx_in2.txt");

  ofstream outfile_intc("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_col.txt");
  ofstream outfile_int1("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in1.txt");
  ofstream outfile_int2("AUG2023_OUTFILE_my_testTESToutputNUMI_tpc3_sel12_West_file_HC_in2.txt");


  ofstream outfile1("hnoCOSangle_by_AUG2023__col_West_file_tpc3.txt");
  ofstream outfile2("hnoCOSangle_by_AUG2023__in1_West_file_tpc3.txt");
  ofstream outfile3("hnoCOSangle_by_AUG2023__in2_West_file_tpc3.txt");

  ofstream outfile1_c_PLUS("hnoCOSangle_by_AUG2023__col_West_file_tpc3_PLUS.txt");
  ofstream outfile2_1_PLUS("hnoCOSangle_by_AUG2023__in1_West_file_tpc3_PLUS.txt");
  ofstream outfile3_2_PLUS("hnoCOSangle_by_AUG2023__in2_West_file_tpc3_PLUS.txt");

  ofstream outfile1_c_MINUS("hnoCOSangle_by_AUG2023__col_West_file_tpc3_MINUS.txt");
  ofstream outfile2_1_MINUS("hnoCOSangle_by_AUG2023__in1_West_file_tpc3_MINUS.txt");
  ofstream outfile3_2_MINUS("hnoCOSangle_by_AUG2023__in2_West_file_tpc3_MINUS.txt");
  ...
  TH1F *h1P = new TH1F("h1P","TPC3 West Cryostat MC COL (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC3 West Cryostat MC COL (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC3 West Cryostat MC IN2 (P) ", 100., 0.0, 5.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC3 West Cryostat MC IN2 (M) ", 100., 0.0, 5.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC3 West Cryostat MC IN1 (P) ", 100., 0.0, 5.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC3 West Cryostat MC IN1 (M) ", 100., 0.0, 5.0);
  h3m->GetXaxis()->SetTitle("angle (radians)");



  TH2F *hz_hor_dQdx_East_tpc3_COL=new TH2F("hz_hor_dQdx_East_tpc3_COL","Horizontal Angle vs  dQdx COL", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc3_COL->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc3_COL->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_dQdx_East_tpc3_IN2=new TH2F("hz_hor_dQdx_East_tpc3_IN2","Horizontal Angle vs  dQdx IN2", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc3_IN2->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc3_IN2->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_dQdx_East_tpc3_IN1=new TH2F("hz_hor_dQdx_East_tpc3_IN1","Horizontal Angle vs  dQdx IN1", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_dQdx_East_tpc3_IN1->GetYaxis()->SetTitle("dQdx ");
  hz_hor_dQdx_East_tpc3_IN1->GetXaxis()->SetTitle("Horizontal angle in radians");

  TH2F *hz_hor_INT_East_tpc3_COL=new TH2F("hz_hor_INT_East_tpc3_COL","Horizontal Angle vs  INT COL", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc3_COL->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc3_COL->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_INT_East_tpc3_IN2=new TH2F("hz_hor_INT_East_tpc3_IN2","Horizontal Angle vs  INT IN2", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc3_IN2->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc3_IN2->GetXaxis()->SetTitle("Horizontal angle in radians");
  TH2F *hz_hor_INT_East_tpc3_IN1=new TH2F("hz_hor_INT_East_tpc3_IN1","Horizontal Angle vs  INT IN1", 50., 0., 1.6, 50., 0., 1000.);
  hz_hor_INT_East_tpc3_IN1->GetYaxis()->SetTitle("INT ");
  hz_hor_INT_East_tpc3_IN1->GetXaxis()->SetTitle("Horizontal angle in radians");


  TH2F *hz_plus_dQdx_East_tpc3_COL=new TH2F("hz_plus_dQdx_East_tpc3_COL","Horizontal plus Angle vs dQdx COL", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_plus_dQdx_East_tpc3_IN2=new TH2F("hz_plus_dQdx_East_tpc3_IN2","Horizontal plus Angle vs dQdx IN2", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_plus_dQdx_East_tpc3_IN1=new TH2F("hz_plus_dQdx_East_tpc3_IN1","Horizontal plus Angle vs dQdx IN1", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_plus_INT_East_tpc3_COL=new TH2F("hz_plus_INT_East_tpc3_COL","Horizontal plus Angle vs  INT COL", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_plus_INT_East_tpc3_IN2=new TH2F("hz_plus_INT_East_tpc3_IN2","Horizontal plus Angle vs  INT IN2", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_plus_INT_East_tpc3_IN1=new TH2F("hz_plus_INT_East_tpc3_IN1","Horizontal plus Angle vs  INT IN1", 50., 0., 5, 50., 0., 1000.);
  ...
  TH2F *hz_minus_dQdx_East_tpc3_COL=new TH2F("hz_minus_dQdx_East_tpc3_COL","Horizontal minus Angle vs dQdx COL", 50., -2., 3, 50., 0., 1000.);
  ...
  TH2F *hz_minus_dQdx_East_tpc3_IN2=new TH2F("hz_minus_dQdx_East_tpc3_IN2","Horizontal minus Angle vs dQdx IN2", 50., -2., 3, 50., 0., 1000.);
  ...
  TH2F *hz_minus_dQdx_East_tpc3_IN1=new TH2F("hz_minus_dQdx_East_tpc3_IN1","Horizontal minus Angle vs dQdx IN1", 50., -2., 3, 50., 0., 1000.);
  ...
  TH2F *hz_minus_INT_East_tpc3_COL=new TH2F("hz_minus_INT_East_tpc3_COL","Horizontal minus Angle vs  INT COL", 50., -2., 3, 50., 0., 1000.);
  ...
  TH2F *hz_minus_INT_East_tpc3_IN2=new TH2F("hz_minus_INT_East_tpc3_IN2","Horizontal minus Angle vs  INT IN2", 50., -2., 3, 50., 0., 1000.);
  ...
  TH2F *hz_minus_INT_East_tpc3_IN1=new TH2F("hz_minus_INT_East_tpc3_IN1","Horizontal minus Angle vs  INT IN1", 50., -2., 3, 50., 0., 1000.);
 ...
 outfile<< "Number of files in our MC list is " << my_files->GetNFiles() <<endl;
   ...
   */
   ...
   cnvs1p->SaveAs("MC_tpc3_sel12_West_file_xyz_col_angle_NEW_h_AUG2023.pdf");
   cnvs2p->SaveAs("MC_tpc3_sel12_West_file_xyz_in1_angle_NEW_h_AUG2023.pdf");
   cnvs3p->SaveAs("MC_tpc3_sel12_West_file_xyz_in2_angle_NEW_h_AUG2023.pdf");
   ...
   cnvs1pDQ->SaveAs("MC_tpc3_sel12_West_file_xyz_col_DQDX_NEW_h_AUG2023.pdf");
   cnvs2pDQ->SaveAs("MC_tpc3_sel12_West_file_xyz_in1_DQDX_NEW_h_AUG2023.pdf");
   cnvs3pDQ->SaveAs("MC_tpc3_sel12_West_file_xyz_in2_DQDX_NEW_h_AUG2023.pdf");
   ...
   cnvs1pI->SaveAs("MC_tpc3_sel12_West_file_xyz_col_INT_NEW_h_AUG2023.pdf");
   cnvs2pI->SaveAs("MC_tpc3_sel12_West_file_xyz_in1_INT_NEW_h_AUG2023.pdf");
   cnvs3pI->SaveAs("MC_tpc3_sel12_West_file_xyz_in2_INT_NEW_h_AUG2023.pdf");
   ...
   h1m->Draw("HIST");
   cnvs1P->SaveAs("COL_MC_tpc3_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs1m->SaveAs("COL_MC_tpc3_sel12_West_file_angle_MINUS_AUG2023.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("IN2_MC_tpc3_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs2m->SaveAs("IN2_MC_tpc3_sel12_West_file_angle_MINUS_AUG2023.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("IN1_MC_tpc3_sel12_West_file_angle_PLUS_AUG2023.pdf");
   cnvs3m->SaveAs("IN1_MC_tpc3_sel12_West_file_angle_MINUS_AUG2023.pdf");
   ...
   c1->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c2->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c3->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c4->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c5->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_dqdx_VS_horizontalAngle_AUG2023.pdf");
   c6->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_integral_VS_horizontalAngle_AUG2023.pdf");
   ...
   c11->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c21->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c31->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c41->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c51->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_dqdx_VS_plusAngle_AUG2023.pdf");
   c61->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_integral_VS_plusAngle_AUG2023.pdf");
   ...
   c12->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c22->SaveAs("COL_Profile_MC_tpc3_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");
   ...
   c32->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c42->SaveAs("IN2_Profile_MC_tpc3_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");
   ...
   c52->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_dqdx_VS_minusAngle_AUG2023.pdf");
   c62->SaveAs("IN1_Profile_MC_tpc3_sel12_West_file_integral_VS_minusAngle_AUG2023.pdf");
