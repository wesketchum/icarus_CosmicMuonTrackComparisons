...
void West_2D_tpc0(bool verbose=false) {
  ...
  ifstream ifile1("OUTFILE_mc_my_outputNUMI_tpc0_sel12_West_file_Length_Az_col.txt");
  ifstream ifile2("OUTFILE_mc_my_outputNUMI_tpc0_sel12_West_file_Cint_Az_col.txt");
  ifstream ifile3("OUTFILE_data_my_outputNUMI_tpc0_sel12_West_file_Length_Az_col.txt");
  ifstream ifile4("OUTFILE_data_my_outputNUMI_tpc0_sel12_West_file_Cint_Az_col.txt");
...
for(int n2 = 0; n2 < DATA_L0; n2++){
   ...
   TFile output_file1("my_output_file_2D_my_outputNUMI_SEL12_West_tpc0_fileLength_Az_col.root","RECREATE");
   h1l2Dc_prof->Write();
   h2l2Dc_prof->Write();
   cnvs_l2Dc->Write();

   cnvs_l2Dc->SaveAs("2D_my_outputNUMI_SEL12_West_tpc0_fileLength_Az_col.pdf");
   ...
   TFile output_file22("my_output_file_2D_my_outputNUMI_SEL12_West_tpc0_fileCint_Az_col.root","RECREATE");
   h1ci22D_prof->Write();
   h2ci22D_prof->Write();
   cnvs_ci22D->Write();


   cnvs_ci22D->SaveAs("2D_my_outputNUMI_SEL12_West_tpc0_fileInt_az_col.pdf");
