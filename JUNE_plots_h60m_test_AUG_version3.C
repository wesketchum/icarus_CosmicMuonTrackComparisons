...
void JUNE_plots_h60m_test_AUG_version3(){
  ...
  for(int aa2 = 0; aa2<aa; aa2++){
    ...
    z_SEL12_East_MC_col[aa2] =   (TMath::Pi()/2.0) - SEL12_East_MC_col[aa2] ;
    cout<<TMath::Cos(z_SEL12_East_MC_col[aa2])<<endl;


    h1->Fill(abs( TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_East_MC_col[aa2] )) );
    cout<<TMath::Cos(z_SEL12_East_MC_col[aa2])<<" "<<z_SEL12_East_MC_col[aa2]<<endl;
    cout<<abs(TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_East_MC_col[aa2] ))<<endl;    //" "<<TMath::Cos(z60m_SEL12_East_MC_col[aa2])<<endl;
  }
  ...
  for(int bb2 = 0; bb2<bb; bb2++){
    ...
    z_SEL12_East_MC_in1[bb2] =   (TMath::Pi()/2.0) - SEL12_East_MC_in1[bb2] ;
    h2->Fill(abs( TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_East_MC_in1[bb2] )));
    }


  for(int cc2 = 0; cc2<cc; cc2++){
    z_SEL12_East_MC_in2[cc2] =   (TMath::Pi()/2.0) - SEL12_East_MC_in2[cc2] ;
    h3->Fill(abs( TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_East_MC_in2[cc2] )));
    }
  ...
  for(int dd2 = 0; dd2<dd; dd2++){
    ...
    z_SEL12_West_MC_col[dd2] =   (TMath::Pi()/2.0) - SEL12_West_MC_col[dd2] ;
    h4->Fill(abs( TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_West_MC_col[dd2] ) ));
     }
  ...
  for(int ee2 = 0; ee2<ee; ee2++){
     ...
     z_SEL12_West_MC_in1[ee2] =   (TMath::Pi()/2.0) - SEL12_West_MC_in1[ee2] ;
     h5->Fill(abs( TMath::Cos(   (TMath::Pi()/3.0) - z_SEL12_West_MC_in1[ee2] )));
     }


  for(int ff2 = 0; ff2<ff; ff2++){
    z_SEL12_West_MC_in2[ff2] =   (TMath::Pi()/2.0) - SEL12_West_MC_in2[ff2] ;
    h6->Fill(abs( TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_West_MC_in2[ff2] )));
  }
  ...
  h6->Draw("HIST");
   ...
   cnvs1->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_col_3v.pdf");

  cnvs2->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_in1_3v.pdf");

  cnvs3->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_in2_3v.pdf");


  cnvs4->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_col_3v.pdf");

  cnvs5->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_in1_3v.pdf");

  cnvs6->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_in2_3v.pdf");
