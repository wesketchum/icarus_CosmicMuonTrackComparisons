...
void histos2(bool verbose=false) {
...
//pnfs/icarus/persistent/calibration/calib_ntuples/data/hist_data_dl4_fstrmNUMI*.root"); 
  ...
  TTreeReaderArray<float> pitch2_i1(myReader2, "trk.hits0.pitch");
   ...
   cout<<"HERE_C"<<endl;
   cnvs_az2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_AzimuthalAngle_colTEST.pdf");
   ...
   cnvs_az1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_AzimuthalAngle_in1TEST.pdf");
   //cnvs_az1->Write();
   ...
   cnvs_az0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_AzimuthalAngle_in2TEST.pdf");//,"RECREATE");
   //  cnvs_az0->Write();
 cout<<"az0"<<endl;
   Double_t res_az0[20];
  ...
  cnvs_zz2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_ZenithAngle_colTEST.pdf");//,"RECREATE");
   //   cnvs_zz2->Write();
   ...
   cnvs_zz1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_ZenithAngle_in1TEST.pdf");//,"RECREATE");
   //   cnvs_zz1->Write();
   cout<<"zz1"<<endl;
   Double_t res_zz1[20];
   ...
   legende->Draw();
   cnvs_zz0->Update();
   cnvs_zz0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_ZenithAngle_in2TEST.pdf");//,"RECREATE");
   //   cnvs_zz0->Write();
   cout<<"zz0"<<endl;
   Double_t res_zz0[20];
   ...
   cnvs_q2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_filedQdx_colTEST.pdf");//,"RECREATE");
   //   cnvs_q2->Write();
   ...
   cnvs_q1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_filedQdx_in1TEST.pdf");//,"RECREATE");
   //   cnvs_q1->Write();
   ...
   cnvs_q0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_filedQdx_in2TEST.pdf");//,"RECREATE");
   //   cnvs_q0->Write();
   cout<<"q0"<<endl;
   Double_t res_q0[20];
   ...
   cnvs_r2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileRR_colTEST.pdf");//,"RECREATE");
   //   cnvs_r2->Write();
   cout<<"r2"<<endl;
   Double_t res_r2[20];
   ...
   cnvs_r1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileRR_in1TEST.pdf");//,"RECREATE");
   //cnvs_r1->Write();
   ...
   cnvs_r0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileRR_in2TEST.pdf");//,"RECREATE");
   //   cnvs_r0->Write();
   ...
   cnvs_l->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileLengthTEST.pdf");//,"RECREATE");
   //   cnvs_l->Write();
   ...
   cnvs_t0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileT0TEST.pdf");//,"RECREATE");
   //   cnvs_t0->Write();
   ...
   cnvs_sx->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileStartX_colTEST.pdf");//,"RECREATE");
   //   cnvs_sx->Write();
   ...
   cnvs_sy->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileStartY_in1TEST.pdf");//,"RECREATE");
   //  cnvs_sy->Write();
   ...
   cnvs_sz->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileStartZ_in2TEST.pdf");//,"RECREATE");
   //   cnvs_sz->Write();
   cout<<"sz"<<endl;
   Double_t res_sz[20];
   ...
   cnvs_ex->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileEndX_colTEST.pdf");//,"RECREATE");
   //  cnvs_ex->Write();
   cout<<"ex"<<endl;
   Double_t res_ex[20];
   ...
   cnvs_ey->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileEndY_in1TEST.pdf");//,"RECREATE");
   //  cnvs_ey->Write();
   cout<<"ey"<<endl;
   Double_t res_ey[20];
   ...
   cnvs_ez->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileEndZ_in2TEST.pdf");//,"RECREATE");
   //   cnvs_ez->Write();
   cout<<"ez"<<endl;
   Double_t res_ez[20];
   ...
   cnvs_ci2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileInt_colTEST.pdf");//,"RECREATE");
   // cnvs_ci2->Write();
   ...
   cnvs_ci1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileInt_in1TEST.pdf");//,"RECREATE");
   //   cnvs_ci1->Write();
   cout<<"ci1"<<endl;
   Double_t res_ci1[20];
   ...
   cnvs_ci0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileInt_in2TEST.pdf");//,"RECREATE");
   //   cnvs_ci0->Write();
   cout<<"ci0"<<endl;
   Double_t res_ci0[20];
   ...
   cnvs_wi2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidth_colTEST.pdf");//,"RECREATE");
   //  cnvs_wi2->Write();
   cout<<"wi2"<<endl;
   Double_t res_wi2[20];
   ...
   //   TFile* my_new_file24 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidt//h_col.root","RECREATE");
   //cnvs_wi2->Write();
   ...
   cnvs_wi1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidth_in1TEST.pdf");//,"RECREATE");
   //cnvs_wi1->Write();
   ...
   //   TFile* my_new_file25 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidt//h_in1.root","RECREATE");
   // cnvs_wi1->Write();
   ...
   cnvs_wi0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidth_in2TEST.pdf");//,"RECREATE");
   // cnvs_wi0->Write();
   ...
   //   TFile* my_new_file26 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWidt//h_in2.root","RECREATE");
   //cnvs_wi0->Write();
   ...
   cnvs_w2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWire_colTEST.pdf");//,"RECREATE");
   // cnvs_w2->Write();
   cout<<"w2"<<endl;
   Double_t res_w2[20];
   ...
   cnvs_w1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWire_in1TEST.pdf");//,"RECREATE");
   // cnvs_w1->Write();
   cout<<"w1"<<endl;
   Double_t res_w1[20];
   ...
   cnvs_w0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileWire_in2TEST.pdf");//,"RECREATE");
   //cnvs_w0->Write();
   cout<<"w0"<<endl;
   Double_t res_w0[20];
   ...
   cnvs_ti2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileTime_colTEST.pdf");//,"RECREATE");
   //cnvs_ti2->Write();
   ...
   cnvs_ti1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileTime_in1TEST.pdf");//,"RECREATE");
   // cnvs_ti1->Write();
   ...
   cnvs_ti0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileTime_in2TEST.pdf");//,"RECREATE");
   //cnvs_ti0->Write();
   ...
   cnvs_x2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisX_colTEST.pdf");//,"RECREATE");
   //cnvs_x2->Write();
   ...
   cnvs_x1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisX_in1TEST.pdf");//,"RECREATE");
   //cnvs_x1->Write();
   cout<<"x1"<<endl;
   Double_t res_x1[20];
   ...
   cnvs_x0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisX_in2TEST.pdf");//,"RECREATE");
   //cnvs_x0->Write();
   ...
   cnvs_y2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisY_colTEST.pdf");//,"RECREATE");
   //cnvs_y2->Write();
   cout<<"y2"<<endl;
   Double_t res_y2[20];
   ...
   cnvs_y1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisY_in1TEST.pdf");//,"RECREATE");
   //cnvs_y1->Write();
   ...
   cnvs_y0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisY_in2TEST.pdf");//,"RECREATE");
   //cnvs_y0->Write();
   ...
   cnvs_z2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisZ_colTEST.pdf");//,"RECREATE");
   //cnvs_z2->Write();
   ...
   cnvs_z1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisZ_in1TEST.pdf");//,"RECREATE");
   //   cnvs_z1->Write();
   ...
   cnvs_z0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_fileDisZ_in2TEST.pdf");//,"RECREATE");
   // cnvs_z0->Write();
   cout<<"z0"<<endl;
   Double_t res_z0[20];
   ...
   cnvs_p2->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitch_colTEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
  ...
  //  cnvs_p2->Write();
   ...
   //   TFile* my_new_file42 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitc//h_col.root","RECREATE"); // open new file in write mode                                                                                         
   //cnvs_p2->Write();
   ...
   cnvs_p1->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitch_in1TEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
  ...
  //  cnvs_p1->Write();
   ...
   //   TFile* my_new_file43 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitc//h_in1.root","RECREATE"); // open new file in write mode                                                                                            
   //cnvs_p1->Write();
   ...
   cnvs_p0->SaveAs("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitch_in2TEST.pdf");//,"RECREATE"); // open new file in write mode                                                           \
   ...
   //   TFile* my_new_file44 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_outputNUMI_tpc0_sel0_East_file_Pitc//h_in2.root","RECREATE"); // open new file in write mode                                                                               
   //cnvs_p0->Write();
