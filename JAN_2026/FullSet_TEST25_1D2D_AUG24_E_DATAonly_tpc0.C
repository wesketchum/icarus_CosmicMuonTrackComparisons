...
void FullSet_TEST25_1D2D_AUG24_E_DATAonly_tpc0(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream outfile_col_mc_xyz("dataAUG2026_NUMI_tpc0_sel12_East_file_xyz_col.txt");
  ofstream outfile_in2_mc_xyz("dataAUG2026_NUMI_tpc0_sel12_East_file_xyz_in2.txt");
  ofstream outfile_in1_mc_xyz("dataAUG2026_NUMI_tpc0_sel12_East_file_xyz_in1.txt");

  ofstream outfile_dqdxc("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_col.txt");
  ofstream outfile_dqdx1("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_in1.txt");
  ofstream outfile_dqdx2("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_Qdx_in2.txt");

  ofstream outfile_intc("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_col.txt");
  ofstream outfile_int1("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_in1.txt");
  ofstream outfile_int2("dataAUG2026_OUTFILE_my_testTESToutputNUMI_tpc0_sel12_East_file_HC_in2.txt");


  ofstream outfile1("datahnoCOSangle_by_AUG2026__col_East_file_tpc0.txt");
  ofstream outfile2("datahnoCOSangle_by_AUG2026__in1_East_file_tpc0.txt");
  ofstream outfile3("datahnoCOSangle_by_AUG2026__in2_East_file_tpc0.txt");

  ofstream outfile1_c_PLUS("datahnoCOSangle_by_AUG2026__col_East_file_tpc0_PLUS.txt");
  ofstream outfile2_1_PLUS("datahnoCOSangle_by_AUG2026__in1_East_file_tpc0_PLUS.txt");
  ofstream outfile3_2_PLUS("datahnoCOSangle_by_AUG2026__in2_East_file_tpc0_PLUS.txt");

  ofstream outfile1_c_MINUS("datahnoCOSangle_by_AUG2026__col_East_file_tpc0_MINUS.txt");
  ofstream outfile2_1_MINUS("datahnoCOSangle_by_AUG2026__in1_East_file_tpc0_MINUS.txt");
  ofstream outfile3_2_MINUS("datahnoCOSangle_by_AUG2026__in2_East_file_tpc0_MINUS.txt");

  
  ofstream outT("AUG2026.txt");
  double z_p = 1.0;
  ...
  TH1F *h1p = new TH1F("h1p","TPC0 East Cryostat DATA (COL) ", 100., 0.0, 2.0); //0., 7.0);                             
  h1p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h2p = new TH1F("h2p","TPC0 East Cryostat DATA (IN1) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                  
  h2p->GetXaxis()->SetTitle("angle in radians");

  TH1F *h3p = new TH1F("h3p","TPC0 East Cryostat DATA (IN2) ", 100., 0.0, 2.0); //0., 7.0);                                                                                                                                                
  h3p->GetXaxis()->SetTitle("angle in radians");


  TH1F *h1pDQ = new TH1F("h1pDQ","TPC0 East Cryostat DATA (COL) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h1pDQ->GetXaxis()->SetTitle("dQ/dX");


  TH1F *h2pDQ = new TH1F("h2pDQ","TPC0 East Cryostat DATA (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                                                                                                                                      
  h2pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h3pDQ = new TH1F("h3pDQ","TPC0 East Cryostat DATA (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                    
  h3pDQ->GetXaxis()->SetTitle("dQ/dX");

  TH1F *h1pI = new TH1F("h1pI","TPC0 East Cryostat DATA (COL) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h1pI->GetXaxis()->SetTitle("integral");


  TH1F *h2pI = new TH1F("h2pI","TPC0 East Cryostat DATA (IN1) ", 100., 100.0, 1000.0); //0., 7.0);                   \
                                                                                                                      
  h2pI->GetXaxis()->SetTitle("integral");

  TH1F *h3pI = new TH1F("h3pI","TPC0 East Cryostat DATA (IN2) ", 100., 100.0, 1000.0); //0., 7.0);                   \
  ...
  TH1F *h1P = new TH1F("h1P","TPC0 East Cryostat DATA COL (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h1m = new TH1F("h1m","TPC0 East Cryostat DATA COL (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h2P = new TH1F("h2P","TPC0 East Cryostat DATA IN2 (P) ", 100., 0.0, 2.0);
  h1P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h2m = new TH1F("h2m","TPC0 East Cryostat DATA IN2 (M) ", 100., 0.0, 2.0);
  h1m->GetXaxis()->SetTitle("angle (radians)");

  TH1F *h3P = new TH1F("h3P","TPC0 East Cryostat DATA IN1 (P) ", 100., 0.0, 2.0);
  h3P->GetXaxis()->SetTitle("angle (radians)");
  TH1F *h3m = new TH1F("h3m","TPC0 East Cryostat DATA IN1 (M) ", 100., 0.0, 2.0);
  ...
  my_files->AddFromFile("test_DATA_JUNE25.txt");//DEC24_DATA.txt");//DEC24_DATA2.txt");//OCT24_data.txt");//OCT24_data.txt");//July2026_DATA2.txt");//list_DATA24.txt");//DATA24.TXT");///pnfs/sbn/data/sbn_fd/poms_production/data/Run2/reconstructed/icaruscode_v09_72_00_03p01/bnbmajority/calibtuples/00/00/**/**/");//mc_april22versiontest2.txt");//mc_aprilversion.txt");
 outfile<< "Number of files in our DATA list is " << my_files->GetNFiles() <<endl;
  ...
  TTreeReaderArray<float> pitch_i1(myReader, "trk.hits0.pitch");
   ...
   TCanvas* cnvs1p= new TCanvas("cnvs1p", "TPC0 East Cryostat DATA COL",1,1,600,500);
   h1p->Draw("HIST");
   TCanvas* cnvs2p= new TCanvas("cnvs2p", "TPC0 East Cryostat DATA IN1",1,1,600,500);
   h2p->Draw("HIST");
   TCanvas* cnvs3p= new TCanvas("cnvs3p", "TPC0 East Cryostat DATA IN2",1,1,600,500);
   h3p->Draw("HIST");

   cnvs1p->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_col_angle_NEW_h_AUG2026.pdf");
   cnvs2p->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in1_angle_NEW_h_AUG2026.pdf");
   cnvs3p->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in2_angle_NEW_h_AUG2026.pdf");

   TCanvas* cnvs1pDQ= new TCanvas("cnvs1pDQ", "TPC0 East Cryostat DATA COL",1,1,600,500);
   h1pDQ->Draw("HIST");
   TCanvas* cnvs2pDQ= new TCanvas("cnvs2pDQ", "TPC0 East Cryostat DATA IN1",1,1,600,500);
   h2pDQ->Draw("HIST");
   TCanvas* cnvs3pDQ= new TCanvas("cnvs3pDQ", "TPC0 East Cryostat DATA IN2",1,1,600,500);
   h3pDQ->Draw("HIST");

   cnvs1pDQ->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_col_DQDX_NEW_h_AUG2026.pdf");
   cnvs2pDQ->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in1_DQDX_NEW_h_AUG2026.pdf");
   cnvs3pDQ->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in2_DQDX_NEW_h_AUG2026.pdf");


   TCanvas* cnvs1pI= new TCanvas("cnvs1pI", "TPC0 East Cryostat DATA COL",1,1,600,500);
   h1pI->Draw("HIST");
   TCanvas* cnvs2pI= new TCanvas("cnvs2pI", "TPC0 East Cryostat DATA IN1",1,1,600,500);
   h2pI->Draw("HIST");
   TCanvas* cnvs3pI= new TCanvas("cnvs3pI", "TPC0 East Cryostat DATA IN2",1,1,600,500);
   h3pI->Draw("HIST");

   cnvs1pI->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_col_INT_NEW_h_AUG2026.pdf");
   cnvs2pI->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in1_INT_NEW_h_AUG2026.pdf");
   cnvs3pI->SaveAs("May25/DATA_tpc0_sel12_East_file_xyz_in2_INT_NEW_h_AUG2026.pdf");



   TCanvas* cnvs1P= new TCanvas("cnvs1P", "TPC0 East Cryostat DATA COL Plus",1,1,600,500);
   h1P->Draw("HIST");
   TCanvas* cnvs1m= new TCanvas("cnvs1m", "TPC0 East Cryostat DATA COL Minus",1,1,600,500);
   h1m->Draw("HIST");
   cnvs1P->SaveAs("May25/COL_DATA_tpc0_sel12_East_file_angle_PLUS_AUG2026.pdf");
   cnvs1m->SaveAs("May25/COL_DATA_tpc0_sel12_East_file_angle_MINUS_AUG2026.pdf");
   ...
   h2m->Draw("HIST");
   cnvs2P->SaveAs("May25/IN2_DATA_tpc0_sel12_East_file_angle_PLUS_AUG2026.pdf");
   cnvs2m->SaveAs("May25/IN2_DATA_tpc0_sel12_East_file_angle_MINUS_AUG2026.pdf");
   ...
   h3m->Draw("HIST");
   cnvs3P->SaveAs("May25/IN1_DATA_tpc0_sel12_East_file_angle_PLUS_AUG2026.pdf");
   cnvs3m->SaveAs("May25/IN1_DATA_tpc0_sel12_East_file_angle_MINUS_AUG2026.pdf");
   ...
   c1->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_AUG2026.pdf");
   c2->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_AUG2026.pdf");
   ...
   c3->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_AUG2026.pdf");
   c4->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_AUG2026.pdf");
   ...
   c5->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_horizontalAngle_AUG2026.pdf");
   c6->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_horizontalAngle_AUG2026.pdf");
   ...
   c11->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_AUG2026.pdf");
   c21->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_AUG2026.pdf");
   ...
   c31->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_AUG2026.pdf");
   c41->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_AUG2026.pdf");
   ...
   c51->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_plusAngle_AUG2026.pdf");
   c61->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_plusAngle_AUG2026.pdf");
   ...
   c12->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_AUG2026.pdf");
   c22->SaveAs("May25/COL_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_AUG2026.pdf");
   ...
   c32->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_AUG2026.pdf");
   c42->SaveAs("May25/IN2_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_AUG2026.pdf");
   ...
   c52->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_dqdx_VS_minusAngle_AUG2026.pdf");
   c62->SaveAs("May25/IN1_Profile_DATA_tpc0_sel12_East_file_integral_VS_minusAngle_AUG2026.pdf");
