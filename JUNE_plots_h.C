...
void JUNE_plots_h(){
  ...
  h6->Draw("HIST");
   ...
   cnvs1->SaveAs("MC_tpc3_sel12_East_file_HAngle_col.pdf");

  cnvs2->SaveAs("MC_tpc3_sel12_East_file_HAngle_in1.pdf");

  cnvs3->SaveAs("MC_tpc3_sel12_East_file_HAngle_in2.pdf");


  cnvs4->SaveAs("MC_tpc3_sel12_West_file_HAngle_col.pdf");

  cnvs5->SaveAs("MC_tpc3_sel12_West_file_HAngle_in1.pdf");

  cnvs6->SaveAs("MC_tpc3_sel12_West_file_HAngle_in2.pdf");
