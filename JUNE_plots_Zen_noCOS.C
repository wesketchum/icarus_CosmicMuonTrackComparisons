...
void JUNE_plots_Zen_noCOS(){
  ...
  TCanvas* cnvs4= new TCanvas("cnvs4", "TPC0 West Cryostat MC",1,1,600,500);
  h4->Draw("HIST");

  TCanvas* cnvs5= new TCanvas("cnvs5", "TPC0 West Cryostat MC",1,1,600,500);
  h5->Draw("HIST");


  TCanvas* cnvs6= new TCanvas("cnvs6", "TPC0 West Cryostat MC",1,1,600,500);
  h6->Draw("HIST");


   cnvs1->SaveAs("MC_tpc0_sel12_East_file_ZenithAngle_col_noCOS.pdf");

  cnvs2->SaveAs("MC_tpc0_sel12_East_file_ZenithAngle_in1_noCOS.pdf");

  cnvs3->SaveAs("MC_tpc0_sel12_East_file_ZenithAngle_in2_noCOS.pdf");


  cnvs4->SaveAs("MC_tpc0_sel12_West_file_ZenithAngle_col_noCOS.pdf");

  cnvs5->SaveAs("MC_tpc0_sel12_West_file_ZenithAngle_in1_noCOS.pdf");

  cnvs6->SaveAs("MC_tpc0_sel12_West_file_ZenithAngle_in2_noCOS.pdf");
