...
void JUNE_plots_h60m_test_AUG_version1(){
  ...
  for(int aa2 = 0; aa2<aa; aa2++){
    ...
    cout<<TMath::Cos(  (TMath::Pi()/3.0) - z_SEL12_East_MC_col[aa2] )<<endl;
  ...
  h6->Draw("HIST");
   ...
   cnvs1->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_col_1v.pdf");

  cnvs2->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_in1_1v.pdf");

  cnvs3->SaveAs("MC_tpc0_sel12_East_file_HAngle_m60_test_in2_1v.pdf");


  cnvs4->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_col_1v.pdf");

  cnvs5->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_in1_1v.pdf");

  cnvs6->SaveAs("MC_tpc0_sel12_West_file_HAngle_m60_test_in2_1v.pdf");
