...
void JUNE_plots_h60m_test_noCOS(){
  ...
  h6->Draw("HIST");
   ...
   cnvs1->SaveAs("MC_tpc3_sel12_East_file_HAngle_m60_test_col_noCOS.pdf");

  cnvs2->SaveAs("MC_tpc3_sel12_East_file_HAngle_m60_test_in1_noCOS.pdf");

  cnvs3->SaveAs("MC_tpc3_sel12_East_file_HAngle_m60_test_in2_noCOS.pdf");


  cnvs4->SaveAs("MC_tpc3_sel12_West_file_HAngle_m60_test_col_noCOS.pdf");

  cnvs5->SaveAs("MC_tpc3_sel12_West_file_HAngle_m60_test_in1_noCOS.pdf");

  cnvs6->SaveAs("MC_tpc3_sel12_West_file_HAngle_m60_test_in2_noCOS.pdf");
