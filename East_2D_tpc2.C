...
void East_2D_tpc2(bool verbose=false) {
...
for(int n2 = 0; n2 < DATA_L0; n2++){
   ...
   TFile output_file1("my_output_file_2D_my_outputNUMI_SEL12_East_tpc2_fileLength_Az_col.root","RECREATE");
   h1l2Dc_prof->Write();
   h2l2Dc_prof->Write();
   cnvs_l2Dc->Write();

   cnvs_l2Dc->SaveAs("2D_my_outputNUMI_SEL12_East_tpc2_fileLength_Az_col.pdf");
   ...
   TFile output_file22("my_output_file_2D_my_outputNUMI_SEL12_East_tpc2_fileCint_Az_col.root","RECREATE");
   h1ci22D_prof->Write();
   h2ci22D_prof->Write();
   cnvs_ci22D->Write();


   cnvs_ci22D->SaveAs("2D_my_outputNUMI_SEL12_East_tpc2_fileInt_az_col.pdf");
