...
void Nov1D(bool verbose=false) {


  gStyle->SetOptStat(0);
  ofstream outfile("t.txt");
  ofstream out0("mcJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_col.txt");
  ofstream out1("mcJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_in1.txt");
  ofstream out2("mcJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_in2.txt");

  ofstream outb0("dataJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_col.txt");
  ofstream outb1("dataJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_in1.txt");
  ofstream outb2("dataJUNE_NUMI_tpc0_sel12_East_file_ZenithAngle_in2.txt");
 ...
 ofstream outfileqc("OUTFILE_my_testTESToutputNUMI_tpc0_sel0_East_file_Qdx_col.txt");
  ...
  ofstream outfileq2("OUTFILE_my_testTESToutputNUMI_tpc0_sel0_East_file_Qdx_in2.txt");
  /*
...
//pnfs/icarus/persistent/calibration/calib_ntuples/data/hist_data_dl4_fstrmNUMI*.root"); 
  ...
  TTreeReaderArray<float> pitch2_i1(myReader2, "trk.hits0.pitch");
   ...
   //   TFile* my_new_file1 = new TFile("/icarus/data/users/obitter/CalibrationWS21/histos_for_analysis/my_testTESToutputNUMI_tpc0_SEL12_East_file_AzimuthalAngle_col.root","RECREATE");
   // cnvs_az2->Write();
