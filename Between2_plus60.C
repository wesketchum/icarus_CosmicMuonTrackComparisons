...
void Between2_plus60(){
  ...
  ofstream outfile1("p60noCOSangle_by_col_E_tpc0.txt");
  ofstream outfile2("p60noCOSangle_by_in1_E_tpc0.txt");
  ofstream outfile3("p60noCOSangle_by_in2_E_tpc0.txt");
  ofstream outfile4("p60noCOSangle_by_col_W_tpc0.txt");
  ofstream outfile5("p60noCOSangle_by_in1_W_tpc0.txt");
  ofstream outfile6("p60noCOSangle_by_in2_W_tpc0.txt");
  ...
  */
  //rotation plus 60 on x-axis
  double y = 0.0;
  double z = 1.0;

  double y_p = y*TMath::Cos((Pi)/3.0) - z*TMath::Sin((Pi)/3.0);     
  double z_p = y*TMath::Sin((Pi)/3.0) + z*TMath::Cos((Pi)/3.0);     
  ...
  cnvs1p->SaveAs("MC_tpc0_sel12_East_file_xyz_col_angle_NEW_p60.pdf");
  cnvs2p->SaveAs("MC_tpc0_sel12_East_file_xyz_in1_angle_NEW_p60.pdf");
  cnvs3p->SaveAs("MC_tpc0_sel12_East_file_xyz_in2_angle_NEW_p60.pdf");
  cnvs4p->SaveAs("MC_tpc0_sel12_West_file_xyz_col_angle_NEW_p60.pdf");
  cnvs5p->SaveAs("MC_tpc0_sel12_West_file_xyz_in1_angle_NEW_p60.pdf");
  cnvs6p->SaveAs("MC_tpc0_sel12_West_file_xyz_in2_angle_NEW_p60.pdf");
