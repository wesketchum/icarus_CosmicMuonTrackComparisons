...
void Between(){
  ...
  ofstream outfile1("noCOSangle_wrt_col_E.txt");
  ofstream outfile2("noCOSangle_wrt_in2_E.txt");
  ofstream outfile3("noCOSangle_wrt_col_W.txt");
  ofstream outfile4("noCOSangle_wrt_in2_W.txt");

  TH1F *h1p = new TH1F("h1p","TPC0 East Cryostat MC (COL) ", 100., 0.0, 2.0); //0., 7.0);                           
  h1p->GetXaxis()->SetTitle("angle wrt horizontal in radians");

  TH1F *h2p = new TH1F("h2p","TPC0 West Cryostat MC (COL) ", 100., 0.0, 2.0); //0., 7.0);                           
  ...
  TH1F *h4p = new TH1F("h4p","TPC0 West Cryostat MC (IN2) ", 100., 0.0, 2.0); //0., 7.0);                           
  ...
  cnvs1p->SaveAs("MC_tpc0_sel12_East_file_xyz_col_angle_NEW.pdf");
  cnvs2p->SaveAs("MC_tpc0_sel12_West_file_xyz_col_angle_NEW.pdf");
  cnvs3p->SaveAs("MC_tpc0_sel12_East_file_xyz_in2_angle_NEW.pdf");
  cnvs4p->SaveAs("MC_tpc0_sel12_West_file_xyz_in2_angle_NEW.pdf");
